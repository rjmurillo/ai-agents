...
PROMPTS: dict[str, list[dict[str, str]]] = {
    ...
    "adr-generator": [
        ...
        {"prompt": "I wrote an ADR with only one alternative and no negative consequences. What's wrong?",
         "expected": "Two anti-patterns: Fairy Tale (no cons) and Sprint/Rush (only one option). Quality checklist requires at least 2 alternatives with pros/cons and at least 1 negative consequence. ecADR criterion 'c' (Criteria) also fails."},
