...
MODEL_PRICING_RATES_USD_PER_1K_TOKENS: dict[str, dict[str, float]] = {
    ...
    # Opus 5.5: $4/$20 per MTok, from the Claude API model table read
    # 2026-09-24. The dotted id is the Copilot CLI spelling that
    # scripts/eval/panels/owner-copilot-cli.json dispatches.
