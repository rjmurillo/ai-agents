...
from _runtime_cli_report import build_argv, fixture_record, probe_versions
...
def run_evaluation(
    *,
    ...
    report: dict[str, object] = {
        ...
        "cli_versions": probe_versions(output, claude_bin, copilot_bin, runner, timeout),
        "fixture_count": len(fixtures),
        "fixtures": [],
        "verdict": "DRY_RUN" if dry_run else "PASS",
    }
    if dry_run:
        report["fixtures"] = [fixture_record(fixture) for fixture in fixtures]
