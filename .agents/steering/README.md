...
| `security-practices.md` | `**/Auth/**,*.env*,**/*.secrets.*,.github/workflows/**,lefthook.*,scripts/validation/git_hook_policy.py` | Security best practices | `.github/instructions/security.instructions.md` |
