...
| claude-model-patches.md all sections | 4,434 | **DONE** (PR1, this branch): moved (gstack preambles already carry the three nudges) | build, ship, test, plan, review |
