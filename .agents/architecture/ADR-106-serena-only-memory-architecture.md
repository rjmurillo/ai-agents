...
| `.serena/memories/adr/adr-037-accepted.md` | Direct. Its `**Status**: Accepted` line and its "Forgetful augmentation" decision become false on merge, and memory is re-injected ahead of reasoning | Repoint; not done here | Medium |
