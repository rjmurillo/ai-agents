...
- `.claude/hooks/Stop/invoke_skill_learning.py:66-95` (previously; hook retired, pattern lives in hook_utilities)
...
- Path validation reference: `.claude/hooks/Stop/invoke_skill_learning.py:66-95` (previously; hook retired)
