...
| [ADR-101](ADR-101-enforcement-planes.md) | Enforcement Planes | 2026-08-20 | Adopt enforcement plane classification as this repository's rule for gate design, and treat the control plane's current gaps as prerequisites rather than as background. | , and concluded without consensus. Rounds 12 and 13 of `adr-review` ran on 2026-09-09 after the repository owner ruled the ten-round cap binding. Round 12 returned two Blocks, both settled by... |
