...
| [ADR-005](ADR-005-powershell-only-scripting.md) | PowerShell-Only Scripting Standard |
...
| [ADR-042](ADR-042-python-migration-strategy.md) | Python Migration Strategy |
...
| [ADR-055](ADR-055-github-actions-runner-selection.md) | GitHub Actions Runner Selection |
