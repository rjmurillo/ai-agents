...
# TASK-024: ADR-108 amendment, spec artifacts, and index regeneration (A0)
...
- REQ-021, DESIGN-020, TASK-024 to TASK-026, the ontology fragment, and the plan are committed; `validate_spec_frontmatter.py` passes on the five spec files.
