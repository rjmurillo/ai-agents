...
`.agents/metrics/control-plane-dispositions-v0.7.0.md` as
...
- `.agents/metrics/control-plane-baseline-v0.7.0.json` records
...
Searched: `.serena/memories/` (ci, knowledge), `.agents/plans/`, `scripts/`,
