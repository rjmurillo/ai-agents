...
| 2 | P0 | Launcher graceful-degradation (the only control that bounds the wedge blast radius) was an open-ended deferral with no owner. | Promoted to ADR Decision item 5 with the explicit "fail open at the launcher layer" principle; tracked as issue #2230; residual wedge risk marked OPEN in Consequences. |
