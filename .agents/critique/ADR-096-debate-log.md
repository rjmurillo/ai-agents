# ADR-096 Debate Log: Zero Tool-Use Hooks

Six-role `adr-review` debate on `.agents/architecture/ADR-096-zero-tool-use-hooks.md`.
...
3. **`test_adr_hook_claims.py` fails against this ADR's own prose**
   ...
   144, 307-309 in ADR-096, and line 149 in ADR-085. Each needs a
