...
converting any other skill waits on the owner's word. `.agents/specs/design/DESIGN-024-skill-guidance-excerpt-sync.md:72-73`
...
`.agents/specs/design/DESIGN-024-skill-guidance-excerpt-sync.md`" and `:111` says "The
