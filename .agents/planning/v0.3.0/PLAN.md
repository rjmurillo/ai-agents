...
|----------|-------|---------|--------|
| TBD | Context Window Token Optimization | Reduce session start overhead from 41k to ~35k tokens. Merge 3 memory files, compress hooks, remove duplicates. 8 sub-tasks. | **NEW** |
