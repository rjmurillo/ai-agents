...
This policy operationalizes [ADR-017: AI Review Model Routing Strategy](../architecture/ADR-017-model-routing-strategy.md) with compliance requirements, security hardening, and operational procedures.
...
- name: Validate Model Configuration
  ...
  run: |
    echo "::error::copilot-model not specified. See ADR-017 and AI-REVIEW-MODEL-POLICY for routing policy."
    exit 1
```
...
- [ADR-017: AI Review Model Routing Strategy](../architecture/ADR-017-model-routing-strategy.md) - Architectural decision and rationale
...
- [ADR-018: Architecture vs Governance Split Criteria](../architecture/ADR-018-architecture-governance-split-criteria.md) - Defines this split pattern
...
- [ADR-017 Debate Log](../architecture/ADR-017-debate-log.md) - Multi-agent debate history
