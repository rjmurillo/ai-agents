...
This document defines the standard format for orphan detection reports generated by `scripts/validation/traceability.py`. The format is optimized for both human review and machine parsing.
...
```bash
python3 scripts/validation/traceability.py --format markdown > orphan-report.md
```
...
- name: Validate Traceability
  run: python3 scripts/validation/traceability.py --strict
