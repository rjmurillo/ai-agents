...
2. **Dry-run protocol validation (pre-commit)**
   - `pwsh scripts/Validate-SessionJson.ps1 -SessionPath ".agents/sessions/2026-01-06-session-811-init-analysis.md" -Format markdown`
...
5. **Single validation pass**
   - `pwsh scripts/Validate-SessionJson.ps1 -SessionPath ".agents/sessions/[session-file].md" -Format markdown`
