...
| architecture | 15 | rule-residual/evidence | .agents/architecture/ADR-0003, ADR-062 | already-owned: thin downstream | architecture-001-rolespecific-tool-allocation-92.md cites ADR-0003 directly |
...
| decision | 42 | evidence | .agents/architecture/ADR-* (per-entry) | already-owned: thin downstream | decision-adr-085-permission-surface-asymmetry.md maps to ADR-085-cross-harness-permission-surface-asymmetry.md |
