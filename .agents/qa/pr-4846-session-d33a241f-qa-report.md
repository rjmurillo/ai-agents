...
qaCommit: d3d52c88897ce24bee5323e734cdfff72302dbc9
---
...
| Command | Result |
|---------|--------|
| `uv run pytest tests/ci/test_validate_vendor_provenance.py tests/workflows/test_workflow_jobs_check_out_repo.py -q` | 307 passed |
...
Delivered: trusted dual-identity and head-event authorization, literal candidate pin parsing, bounded YAML loading, partial vendor tree rejection, current `main`, the setup-uv v10 pin, 307 passing tests, and real validator evidence.
