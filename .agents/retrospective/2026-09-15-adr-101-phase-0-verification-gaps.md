...
- [ ] `.agents/architecture/ADR-101-enforcement-planes.md` lines 408 and 425 say "six of the nine pinned required contexts" and are now six of eight. Left alone deliberately: any ADR edit fires the mandatory review panel.
