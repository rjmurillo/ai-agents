...
| MUST | Route to qa agent (feature implementation) | [N/A] | Bug fix session - QA via PR CI validation |
| MUST | Commit all changes (including .serena/memories) | [x] | Commit SHA: d00063b8 |
