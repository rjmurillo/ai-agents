...
| MUST | Update Serena memory (cross-session context) | [ ] | Pending below |
| MUST | Run markdown lint | [ ] | Pending below |
| MUST | Route to qa agent (feature implementation) | [ ] | Pending below |
| MUST | Commit all changes (including .serena/memories) | [ ] | Pending below |
