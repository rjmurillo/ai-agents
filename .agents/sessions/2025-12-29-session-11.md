...
| MUST | Route to qa agent (feature implementation) | x | SKIPPED: no code changes - only replies and memory update |
| MUST | Commit all changes (including .serena/memories) | x | Commit SHA: _______ |
| MUST NOT | Update `.agents/HANDOFF.md` directly | x | HANDOFF.md unchanged |
| SHOULD | Update PROJECT-PLAN.md | x | SKIPPED: No project plan for this task |
| SHOULD | Invoke retrospective (significant sessions) | x | SKIPPED: Single-task session |
