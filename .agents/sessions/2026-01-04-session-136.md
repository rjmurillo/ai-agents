...
| MUST | Security review export (if exported): `grep -iE "api[_-]?key\|password\|token\|secret\|credential\|private[_-]?key" [file].json` | [ ] | N/A - no export |
...
| MUST | Commit all changes (including .serena/memories) | [x] | Commit SHA: 356ad245 |
