...
| MUST | List skill scripts in `.claude/skills/github/scripts/` | [ ] | N/A - no GitHub operations |
...
- [x] Serena memory updated (`security-012-workflow-author-association`)
- [x] Changes committed (ff6ffad3)
