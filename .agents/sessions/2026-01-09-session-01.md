...
| MUST | List skill scripts in `.claude/skills/github/scripts/` | [ ] | Skills not listed |
| MUST | Read usage-mandatory memory | [x] | Content in context |
| MUST | Read PROJECT-CONSTRAINTS.md | [ ] | Not read in session |
| MUST | Read memory-index, load task-relevant memories | [ ] | Not loaded |
...
2. Push to remote
3. Monitor CI to validate fixes work correctly
