"""Emit the single-dispatcher artifacts for Copilot CLI hooks (ADR-067, #2295).
...
N shim entries) is the reviewed, validated step described in ADR-067; this
...
# AUTO-GENERATED HOOK DISPATCHER ENTRYPOINT (ADR-067, #2295).
