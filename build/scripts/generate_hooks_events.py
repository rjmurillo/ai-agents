...
# Claude-side dispatch-group expansion (#3075) lives in
# generate_hooks_expand.py; re-exported here for callers and tests.
...
def generate_hooks(
    ...
    *,
    ...
    # Drop the generator-internal matcher key on every path (dispatcher or
    # per-shim) so it never reaches the emitted hooks.json.
