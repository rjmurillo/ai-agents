...
- Performance analysis: `.project-toolkit/analysis/gh-native-benchmark.md`

<!-- vendor-portability: declared. This README links .project-toolkit/analysis/gh-native-benchmark.md as the performance write-up. It is a documentation citation; the gh-native scripts run without it and a vendored install loses only the link. Issue #2050. -->
