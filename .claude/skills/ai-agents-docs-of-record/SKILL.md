...
| Serena canonical, Forgetful supplementary | `.agents/architecture/ADR-007-memory-first-architecture.md:83-115` | `grep -n "Canonical" .agents/architecture/ADR-007-memory-first-architecture.md` |
