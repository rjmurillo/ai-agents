...
|---|---|---|
| Hook sources serve different consumers | Re-verified 2026-08-14: `.claude/settings.json` has 6 events and 8 groups; `.claude/hooks/hooks.json` has 2 events and 4 groups | Do not force parity. Verify whether a hook is repository-only or vendored before editing either source |
