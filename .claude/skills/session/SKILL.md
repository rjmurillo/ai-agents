...
<!-- vendor-portability: declared. This skill references protocol/ADR/artifact paths under .agents/ (sessions, architecture, SESSION-PROTOCOL.md, analysis, critique, memory, retrospective, security) for eligibility allowlists and documentation links, and scripts/validate_session_json.py. The eligibility script inspects staged git paths only; missing upstream artifact directories affect docs/reference links, not script I/O. Issue #2050. -->
