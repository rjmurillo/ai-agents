...
<!-- vendor-portability: self-contained. The GP-001 through GP-008 definitions ship with this skill at references/golden-principles.md, so a vendored install retains the canonical principle text. The bundled scanner applies its built-in GP-001 and GP-003 through GP-006 checks against the consumer's files; GP-002 is enforced elsewhere, not by this scanner. Issue #2050. -->
