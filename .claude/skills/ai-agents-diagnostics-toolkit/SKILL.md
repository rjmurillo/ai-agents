...
Written 2026-07-02; every baseline in this skill re-measured 2026-07-29 by running each instrument on this checkout. Retro-cited short SHAs do not resolve locally even with full history present (~1471 commits as of 2026-07-03); do not use `git log` to re-derive any of this.
