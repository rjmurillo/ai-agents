...
.NOTES
    ...
    ALLOWLIST:
    Must match exactly with scripts/Validate-SessionJson.ps1 $InvestigationAllowlist
...
# Investigation-only allowlist patterns (must match Validate-SessionJson.ps1)
