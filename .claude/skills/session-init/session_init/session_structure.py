...
The required-field set mirrors `.agents/SESSION-PROTOCOL.md`. The validator
`scripts/validate_session_json.py` is the authoritative checker; this builder
produces output that satisfies it.
"""
