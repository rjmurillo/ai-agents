...
5. **Tests required**. New validation scripts MUST ship with pytest coverage in `tests/`, or Pester coverage there for grandfathered PowerShell; CI tests MUST NOT live in customer-shipped skill directories.
