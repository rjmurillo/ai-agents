...
1. **Activate Serena project** — load project context via `mcp__serena__activate_project`
...
4. **Query relevant memories** — surface related memories via `mcp__serena__list_memories`
