...
file_matches_allowlist = _mod.file_matches_allowlist
session_claims_investigation_only = _mod.session_claims_investigation_only
validate_investigation_claims = _mod.validate_investigation_claims
...
# ---------------------------------------------------------------------------
# Tests: file_matches_allowlist (pure logic, no git)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tests: session_claims_investigation_only
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tests: validate_investigation_claims (session-based validation)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tests: file_matches_allowlist (session-mode helpers)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tests: validate_investigation_claims (session-mode end-to-end)
# ---------------------------------------------------------------------------
...
class TestValidateInvestigationClaims:
    ...
    def test_valid_claim_passes(self, tmp_path):
        ...
        with patch.object(_mod, "get_commit_for_session", return_value="abc1234"):
            with patch.object(
                _mod,
                "get_files_in_commit",
