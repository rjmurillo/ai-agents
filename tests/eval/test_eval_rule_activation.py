...
def test_trailing_prose_after_valid_json_causes_parse_failure(
...
def test_raw_judge_response_absent_on_clean_parse(monkeypatch):
    """Issue #3975: raw_judge_response is only set on parse failures.

    A cleanly parsed response needs no raw dump.
    """
