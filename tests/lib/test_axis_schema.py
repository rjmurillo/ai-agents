"""Schema validation tests for `.claude/skills/review-axes/references/{role}.md` canonical files.
...
REVIEW_AXES_DIR = REPO_ROOT / ".claude" / "skills" / "review-axes" / "references"
...
def test_no_unexpected_axis_files() -> None:
    """Every `.md` file under .claude/skills/review-axes/references/ must be a known canonical role.
