...
class TestFileMatchesAllowlist:
    def test_matches_sessions_path(self) -> None:
        assert file_matches_allowlist(".project-toolkit/sessions/log.json") is True

    def test_matches_analysis_path(self) -> None:
        assert file_matches_allowlist(".project-toolkit/analysis/report.md") is True
    ...
    def test_matches_architecture_review(self) -> None:
        assert file_matches_allowlist(".project-toolkit/architecture/REVIEW-001.md") is True

    def test_rejects_architecture_adr(self) -> None:
        assert file_matches_allowlist(".project-toolkit/architecture/ADR-001.md") is False
