...
def repo(tmp_path: Path) -> Path:
    ...
    _write(root, ".project-toolkit/architecture/ADR-001-foo.md", "an adr\n")
    _write(root, ".agents/governance/bar.md", "governance doc\n")
    _write(root, ".serena/memories/foo.md", "a memory\n")
    _write(root, ".project-toolkit/memory/episodes/e1.json", "{}\n")
    _write(root, ".project-toolkit/sessions/s1.md", "a session\n")
    _write(root, ".agents/archive/a1.md", "archived\n")
    _write(root, ".project-toolkit/eval-results/r1.json", "{}\n")
