...
tools_vscode: ['vscode', 'execute', 'read', 'edit', 'search', 'cloudmcp-manager/*', 'github/*', 'memory', 'todo', 'serena/*']
tools_copilot: ['shell', 'read', 'edit', 'search', 'cloudmcp-manager/*', 'github/*', 'memory', 'todo', 'serena/*']
---
# Implementer Agent
