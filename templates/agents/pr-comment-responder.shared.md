...
tools_vscode: ['vscode', 'execute', 'read', 'edit', 'search', 'web', 'agent', 'cloudmcp-manager/*', 'github.vscode-pull-request-github/*', 'todo', 'serena/*']
tools_copilot: ['shell', 'read', 'edit', 'search', 'web', 'agent', 'cloudmcp-manager/*', 'todo', 'serena/*']
---
