# incoherence-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `incoherence` skill.
...
- `evals/incoherence-spike/README.md`. Spike rationale and authoring guide.
