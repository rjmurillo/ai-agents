# incoherence Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `incoherence` skill.

## Skill under test

`.claude/skills/incoherence/SKILL.md`

> Detect contradictions between documentation and code, ambiguous specs,

## Why eval-worthy

Detects contradictions between docs and code. Recall and precision are agent-driven.
