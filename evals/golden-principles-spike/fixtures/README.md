# golden-principles-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `golden-principles` skill.
...
- `evals/golden-principles-spike/README.md`. Spike rationale and authoring guide.
