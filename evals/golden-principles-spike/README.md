# golden-principles Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `golden-principles` skill.
...
Scans for principle violations with remediation. Remediation quality is judgment.
