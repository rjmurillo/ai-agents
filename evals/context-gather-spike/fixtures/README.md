# context-gather-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `context-gather` skill.
...
- `evals/context-gather-spike/README.md`. Spike rationale and authoring guide.
