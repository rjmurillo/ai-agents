# decision-critic Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `decision-critic` skill.
...
Stress-tests reasoning. Quality of adversarial perspectives is judgment.
