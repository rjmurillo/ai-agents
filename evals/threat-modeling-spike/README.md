# threat-modeling Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `threat-modeling` skill.
...
OWASP STRIDE matrix generation. Risk-rating accuracy is judgment.
