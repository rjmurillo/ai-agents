# threat-modeling-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `threat-modeling` skill.
...
- `evals/threat-modeling-spike/README.md`. Spike rationale and authoring guide.
