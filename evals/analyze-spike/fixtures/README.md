# analyze-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `analyze` skill.
...
- `evals/analyze-spike/README.md`. Spike rationale and authoring guide.
