# adr-generator-Agent-Spike Fixture Corpus

A/B corpus for the `adr-generator` agent. Empty scaffold.
...
- `evals/adr-generator-agent-spike/README.md`. Spike rationale + authoring guide.
