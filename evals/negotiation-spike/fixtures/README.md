# negotiation-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `negotiation` skill.
...
- `evals/negotiation-spike/README.md`. Spike rationale and authoring guide.
