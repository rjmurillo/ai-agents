# negotiation Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `negotiation` skill.
...
Offer analysis, counter-proposal drafting. Pure judgment.
