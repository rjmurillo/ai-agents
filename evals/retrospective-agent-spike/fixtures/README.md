# retrospective-Agent-Spike Fixture Corpus

A/B corpus for the `retrospective` agent. Empty scaffold.
...
- `evals/retrospective-agent-spike/README.md`. Spike rationale + authoring guide.
