# explainer-Agent-Spike Fixture Corpus

A/B corpus for the `explainer` agent. Empty scaffold.
...
- `evals/explainer-agent-spike/README.md`. Spike rationale + authoring guide.
