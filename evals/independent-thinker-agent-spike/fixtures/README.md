# independent-thinker-Agent-Spike Fixture Corpus

A/B corpus for the `independent-thinker` agent. Empty scaffold.
...
- `evals/independent-thinker-agent-spike/README.md`. Spike rationale + authoring guide.
