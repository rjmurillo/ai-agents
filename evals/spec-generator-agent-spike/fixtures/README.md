# spec-generator-Agent-Spike Fixture Corpus

A/B corpus for the `spec-generator` agent. Empty scaffold.
...
- `evals/spec-generator-agent-spike/README.md`. Spike rationale + authoring guide.
