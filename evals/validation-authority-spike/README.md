# validation-authority Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `validation-authority` skill.
...
Treat upstream validators as authoritative. Behavior under conflict is judgment.
...
```text
evals/validation-authority-spike/
