# validation-authority-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `validation-authority` skill.
...
- `evals/validation-authority-spike/README.md`. Spike rationale and authoring guide.
