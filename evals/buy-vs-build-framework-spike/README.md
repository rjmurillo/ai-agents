# buy-vs-build-framework Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `buy-vs-build-framework` skill.
...
Strategic four-phase evaluation. Recommendation varies with reasoning.
...
```text
evals/buy-vs-build-framework-spike/
