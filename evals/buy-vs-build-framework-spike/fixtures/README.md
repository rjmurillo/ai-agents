# buy-vs-build-framework-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `buy-vs-build-framework` skill.
...
- `evals/buy-vs-build-framework-spike/README.md`. Spike rationale and authoring guide.
