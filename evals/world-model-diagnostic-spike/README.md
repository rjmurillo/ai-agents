# world-model-diagnostic Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `world-model-diagnostic` skill.
...
Twenty-minute paradigm diagnostic. Diagnostic accuracy is judgment.
...
```text
evals/world-model-diagnostic-spike/
