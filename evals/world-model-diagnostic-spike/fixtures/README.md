# world-model-diagnostic-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `world-model-diagnostic` skill.
...
- `evals/world-model-diagnostic-spike/README.md`. Spike rationale and authoring guide.
