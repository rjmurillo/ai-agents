# pre-mortem Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `pre-mortem` skill.
...
Prospective hindsight on project risks. Risk identification depth is judgment.
