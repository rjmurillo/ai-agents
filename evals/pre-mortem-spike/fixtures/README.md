# pre-mortem-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `pre-mortem` skill.
...
- `evals/pre-mortem-spike/README.md`. Spike rationale and authoring guide.
