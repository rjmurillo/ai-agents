# code-qualities-assessment-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `code-qualities-assessment` skill.
...
- `evals/code-qualities-assessment-spike/README.md`. Spike rationale and authoring guide.
