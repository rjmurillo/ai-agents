# code-qualities-assessment Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `code-qualities-assessment` skill.
...
Scores cohesion, coupling, encapsulation, testability, non-redundancy. Judgment-bearing rubric.
