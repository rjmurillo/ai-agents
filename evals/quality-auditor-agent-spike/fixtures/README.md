# quality-auditor-Agent-Spike Fixture Corpus

A/B corpus for the `quality-auditor` agent. Empty scaffold.
...
- `evals/quality-auditor-agent-spike/README.md`. Spike rationale + authoring guide.
