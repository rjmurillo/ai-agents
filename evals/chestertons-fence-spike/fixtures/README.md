# chestertons-fence-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `chestertons-fence` skill.
...
- `evals/chestertons-fence-spike/README.md`. Spike rationale and authoring guide.
