# chestertons-fence Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `chestertons-fence` skill.
...
Historical-context investigation. Conclusions depend on archaeology depth.
