# cynefin-classifier-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `cynefin-classifier` skill.
...
- `evals/cynefin-classifier-spike/README.md`. Spike rationale and authoring guide.
