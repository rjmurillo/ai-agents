# cynefin-classifier Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `cynefin-classifier` skill.
...
Classifies problems into Cynefin domains. Classification accuracy is the eval target.
...
```text
evals/cynefin-classifier-spike/
