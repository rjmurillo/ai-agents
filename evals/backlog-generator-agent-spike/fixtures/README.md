# backlog-generator-Agent-Spike Fixture Corpus

A/B corpus for the `backlog-generator` agent. Empty scaffold.
...
- `evals/backlog-generator-agent-spike/README.md`. Spike rationale + authoring guide.
