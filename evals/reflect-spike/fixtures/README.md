# reflect-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `reflect` skill.
...
- `evals/reflect-spike/README.md`. Spike rationale and authoring guide.
