# adr-generator Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `adr-generator` skill.
...
Generates ADRs. Format adherence, decision quality, and template detection are judgment-bearing.
