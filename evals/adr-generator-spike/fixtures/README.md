# adr-generator-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `adr-generator` skill.
...
- `evals/adr-generator-spike/README.md`. Spike rationale and authoring guide.
