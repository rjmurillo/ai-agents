# task-decomposer-Agent-Spike Fixture Corpus

A/B corpus for the `task-decomposer` agent. Empty scaffold.
...
- `evals/task-decomposer-agent-spike/README.md`. Spike rationale + authoring guide.
