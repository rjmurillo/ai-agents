# serena-code-architecture-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `serena-code-architecture` skill.
...
- `evals/serena-code-architecture-spike/README.md`. Spike rationale and authoring guide.
