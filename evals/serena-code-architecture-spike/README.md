# serena-code-architecture Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `serena-code-architecture` skill.

## Skill under test

`.claude/skills/serena-code-architecture/SKILL.md`
...
Architectural analysis using Serena symbols. Architecture conclusions are judgment.
...
```text
evals/serena-code-architecture-spike/
