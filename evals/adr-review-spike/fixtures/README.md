# adr-review-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `adr-review` skill.
...
- `evals/adr-review-spike/README.md`. Spike rationale and authoring guide.
