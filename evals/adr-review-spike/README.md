# adr-review Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `adr-review` skill.
...
Multi-agent debate orchestration. Verdict quality varies with agent reasoning.
