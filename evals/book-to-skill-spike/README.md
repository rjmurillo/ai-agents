# book-to-skill Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `book-to-skill` skill.
...
Extracts method from a book and hands off to SkillForge. Extraction fidelity is judgment.
