# book-to-skill-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `book-to-skill` skill.
...
- `evals/book-to-skill-spike/README.md`. Spike rationale and authoring guide.
