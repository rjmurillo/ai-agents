# prompt-engineer Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `prompt-engineer` skill.
...
Optimizes system prompts. Pattern selection is judgment.
