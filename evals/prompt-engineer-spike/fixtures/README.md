# prompt-engineer-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `prompt-engineer` skill.
...
- `evals/prompt-engineer-spike/README.md`. Spike rationale and authoring guide.
