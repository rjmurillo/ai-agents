...
Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `review` skill.

## Skill under test

`.claude/skills/review/SKILL.md`

> Review before merge. Nine-axis review across 6 canonical axes (analyst, architect, qa, security, devops, roadmap) plus 3 chained skills (code-qualities-assessment, golden-principles, taste-lints). Run after /test.

## Why eval-worthy

Nine-axis review across six canonical axes plus three chained skills. Pure judgment surface.
