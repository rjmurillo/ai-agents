# review-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `review` skill.
...
- `evals/review-spike/README.md`. Spike rationale and authoring guide.
