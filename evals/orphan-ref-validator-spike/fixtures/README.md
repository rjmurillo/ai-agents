# orphan-ref-validator-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `orphan-ref-validator` skill.
...
- `evals/orphan-ref-validator-spike/README.md`. Spike rationale and authoring guide.
