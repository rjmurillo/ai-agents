...
Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `planner` skill.
...
Decomposes tasks into milestones. Decomposition quality is judgment.
