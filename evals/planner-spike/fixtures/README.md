# planner-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `planner` skill.
...
- `evals/planner-spike/README.md`. Spike rationale and authoring guide.
