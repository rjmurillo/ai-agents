# chaos-experiment Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `chaos-experiment` skill.
...
Designs chaos experiments. Hypothesis and injection-plan quality vary.
