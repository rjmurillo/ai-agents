# chaos-experiment-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `chaos-experiment` skill.
...
- `evals/chaos-experiment-spike/README.md`. Spike rationale and authoring guide.
