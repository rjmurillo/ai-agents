# cva-analysis-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `cva-analysis` skill.
...
- `evals/cva-analysis-spike/README.md`. Spike rationale and authoring guide.
