# cva-analysis Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `cva-analysis` skill.
...
Abstraction discovery via commonality/variability matrix. Pattern emergence is judgment.
