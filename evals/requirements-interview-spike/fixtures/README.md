# requirements-interview-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `requirements-interview` skill.
...
- `evals/requirements-interview-spike/README.md`. Spike rationale and authoring guide.
