# work-operating-model-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `work-operating-model` skill.
...
- `evals/work-operating-model-spike/README.md`. Spike rationale and authoring guide.
