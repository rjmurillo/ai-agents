# work-operating-model Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `work-operating-model` skill.
...
Five-layer interview eliciting team operating model. Elicitation depth is judgment.
...
```text
evals/work-operating-model-spike/
