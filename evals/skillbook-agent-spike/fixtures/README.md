# skillbook-Agent-Spike Fixture Corpus

A/B corpus for the `skillbook` agent. Empty scaffold.
...
- `evals/skillbook-agent-spike/README.md`. Spike rationale + authoring guide.
