# slashcommandcreator Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `slashcommandcreator` skill.
...
Meta-skill for slash commands. Command design is judgment.
...
```text
evals/slashcommandcreator-spike/
