# slashcommandcreator-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `slashcommandcreator` skill.
...
- `evals/slashcommandcreator-spike/README.md`. Spike rationale and authoring guide.
