# slo-designer Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `slo-designer` skill.
...
Designs SLOs, SLIs, alerting thresholds. Design quality is judgment.
