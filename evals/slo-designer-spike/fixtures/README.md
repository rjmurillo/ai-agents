# slo-designer-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `slo-designer` skill.
...
- `evals/slo-designer-spike/README.md`. Spike rationale and authoring guide.
