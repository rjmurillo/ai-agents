# pr-comment-responder-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `pr-comment-responder` skill.
...
- `evals/pr-comment-responder-spike/README.md`. Spike rationale and authoring guide.
