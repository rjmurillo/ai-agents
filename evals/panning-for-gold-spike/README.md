# panning-for-gold Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `panning-for-gold` skill.
...
Triage of unstructured input into thread inventories. Extraction quality is judgment.
