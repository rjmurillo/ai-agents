# panning-for-gold-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `panning-for-gold` skill.
...
- `evals/panning-for-gold-spike/README.md`. Spike rationale and authoring guide.
