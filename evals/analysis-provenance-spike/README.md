# analysis-provenance Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `analysis-provenance` skill.
...
Investigates code ownership. Conclusions depend on evidence gathering.
...
```text
evals/analysis-provenance-spike/
