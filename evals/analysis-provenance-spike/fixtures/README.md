# analysis-provenance-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `analysis-provenance` skill.
...
- `evals/analysis-provenance-spike/README.md`. Spike rationale and authoring guide.
