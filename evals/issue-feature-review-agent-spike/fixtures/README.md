# issue-feature-review-Agent-Spike Fixture Corpus

A/B corpus for the `issue-feature-review` agent. Empty scaffold.
...
- `evals/issue-feature-review-agent-spike/README.md`. Spike rationale + authoring guide.
