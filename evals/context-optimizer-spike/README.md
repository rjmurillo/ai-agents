# context-optimizer Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `context-optimizer` skill.
...
Decides Skill vs Passive Context vs Hybrid placement. Pure judgment.
