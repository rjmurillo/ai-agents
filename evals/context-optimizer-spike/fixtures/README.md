# context-optimizer-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `context-optimizer` skill.
...
- `evals/context-optimizer-spike/README.md`. Spike rationale and authoring guide.
