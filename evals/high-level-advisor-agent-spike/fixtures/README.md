# high-level-advisor-Agent-Spike Fixture Corpus

A/B corpus for the `high-level-advisor` agent. Empty scaffold.
...
- `evals/high-level-advisor-agent-spike/README.md`. Spike rationale + authoring guide.
