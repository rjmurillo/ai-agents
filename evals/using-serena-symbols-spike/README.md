# using-serena-symbols Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `using-serena-symbols` skill.

## Skill under test

`.claude/skills/using-serena-symbols/SKILL.md`
...
Guidance for symbol analysis. Output adherence is the eval target.
...
```
evals/using-serena-symbols-spike/
