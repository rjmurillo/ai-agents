# using-serena-symbols-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `using-serena-symbols` skill.
...
- `evals/using-serena-symbols-spike/README.md`. Spike rationale and authoring guide.
