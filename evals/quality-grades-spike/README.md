# quality-grades Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `quality-grades` skill.
...
Grades quality per domain with gap tracking. Grading is judgment.
