# quality-grades-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `quality-grades` skill.
...
- `evals/quality-grades-spike/README.md`. Spike rationale and authoring guide.
