# orchestrator-Agent-Spike Fixture Corpus

A/B corpus for the `orchestrator` agent. Empty scaffold.
...
- `evals/orchestrator-agent-spike/README.md`. Spike rationale + authoring guide.
