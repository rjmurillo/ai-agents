# merge-resolver-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `merge-resolver` skill.
...
- `evals/merge-resolver-spike/README.md`. Spike rationale and authoring guide.
