# merge-resolver Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `merge-resolver` skill.
...
Resolves conflicts by analyzing intent. Resolution quality varies with reasoning.
