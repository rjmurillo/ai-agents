# SkillForge-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `SkillForge` skill.
...
- `evals/SkillForge-spike/README.md`. Spike rationale and authoring guide.
