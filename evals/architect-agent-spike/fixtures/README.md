# architect-Agent-Spike Fixture Corpus

A/B corpus for the `architect` agent. Empty scaffold.
...
- `evals/architect-agent-spike/README.md`. Spike rationale + authoring guide.
