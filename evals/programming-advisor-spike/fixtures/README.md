# programming-advisor-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `programming-advisor` skill.
...
- `evals/programming-advisor-spike/README.md`. Spike rationale and authoring guide.
