# programming-advisor Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `programming-advisor` skill.
...
Evaluates existing solutions before custom build. Recommendation varies.
...
```text
evals/programming-advisor-spike/
