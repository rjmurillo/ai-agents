# milestone-planner-Agent-Spike Fixture Corpus

A/B corpus for the `milestone-planner` agent. Empty scaffold.
...
- `evals/milestone-planner-agent-spike/README.md`. Spike rationale + authoring guide.
