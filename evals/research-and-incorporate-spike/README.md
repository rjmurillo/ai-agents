# research-and-incorporate Eval Spike

Held-out agent-vs-baseline corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `research-and-incorporate` skill.

## Skill under test

`.claude/skills/research-and-incorporate/SKILL.md`

> Research external topics, create comprehensive analysis, determine project

## Why eval-worthy

External research synthesis. Synthesis quality is judgment.
...
```text
evals/research-and-incorporate-spike/
