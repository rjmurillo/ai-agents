# research-and-incorporate-Spike Fixture Corpus

Held-out corpus driving `scripts/eval/eval-agent-vs-baseline.py` against the `research-and-incorporate` skill.
...
- `evals/research-and-incorporate-spike/README.md`. Spike rationale and authoring guide.
