...
|---|---|---|
| `.github/instructions` | Copilot working in this repository | 8 rules, 73,909 bytes |
| `src/copilot-cli/instructions` | the shipped plugin, installed elsewhere | 8 rules, 73,909 bytes |
