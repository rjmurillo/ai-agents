...
The two destination trees now agree, measured on this branch after PR #5433 (issue #5404) added terminal-state completion-contract prose to `builder-ethos` and `voice`:

| Tree | Consumer | Always-on |
|---|---|---|
| `.github/instructions` | Copilot working in this repository | 7 rules, 71,071 bytes |
| `src/copilot-cli/instructions` | the shipped plugin, installed elsewhere | 7 rules, 71,071 bytes |
