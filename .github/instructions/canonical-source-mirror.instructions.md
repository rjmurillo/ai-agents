...
The two destination trees now agree, re-measured after the universal rule updates:

| Tree | Consumer | Always-on |
|---|---|---|
| `.github/instructions` | Copilot working in this repository | 8 rules, 73,434 bytes |
| `src/copilot-cli/instructions` | the shipped plugin, installed elsewhere | 8 rules, 73,434 bytes |
