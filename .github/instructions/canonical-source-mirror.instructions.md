...
|---|---|---|
| `.github/instructions` | Copilot working in this repository | 7 rules, 70,236 bytes |
| `src/copilot-cli/instructions` | the shipped plugin, installed elsewhere | 7 rules, 70,236 bytes |
