...
The two destination trees now agree, measured on this branch after `lsp-first`
was scoped to code files instead of `**`:

| Tree | Consumer | Always-on |
|---|---|---|
| `.github/instructions` | Copilot working in this repository | 7 rules, 68,531 bytes |
