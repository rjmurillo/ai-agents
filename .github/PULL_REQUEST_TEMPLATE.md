...
- [ ] Pre-PR validation passed (`uv run python scripts/validation/pre_pr.py`; `--quick` drops four slow gates, measured at under 2 percent of the run, so prefer the full sequence)
