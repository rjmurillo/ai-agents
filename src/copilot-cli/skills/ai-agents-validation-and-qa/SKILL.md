...
`.project-toolkit/architecture/ADR-034-investigation-session-qa-exemption.md`:
...
Explicitly NOT skippable: `.project-toolkit/planning/`, `.project-toolkit/architecture/ADR-*`,
