...
|---|---|---|
| Hook sources serve different consumers | `.claude/settings.json` has 5 events and 7 groups; `.claude/hooks/hooks.json` has 2 events and 2 groups | Do not force parity. Verify whether a hook is repository-only or vendored before editing either source |
