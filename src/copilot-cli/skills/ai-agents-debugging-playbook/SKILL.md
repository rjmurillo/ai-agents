...
| install-parity checks co-change, not content; skips `RULE` and hand-maintained-only diffs | `build/scripts/validate_install_parity.py:629-644` | `sed -n '629,644p' build/scripts/validate_install_parity.py` |
