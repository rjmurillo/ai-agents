...
_GENERATED_PATH_SEGMENTS: tuple[tuple[str, ...], ...] = (
    ...
    # Coarse: matches every file under these two roots, including
    # .claude/rules/testing.md, which stays hand-maintained (no template
    # exists for it; see .agents/governance/GENERATOR-FILES.md). That one
    # file is misclassified as generated by this path-only check; the
    # consequence is a skipped lint on an already-reviewed rule file, not a
    # correctness gap the way an unclassified generated file would be.
    ("src", "claude", "rules"),
    (".claude", "rules"),
)
_GENERATED_MARKERS = (
