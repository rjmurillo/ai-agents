...
<!-- vendor-portability: declared. This README links .project-toolkit/analysis/context-engineering.md as background. It is a documentation citation; the count-tokens script runs without it and a vendored install loses only the link. Issue #2050. -->
