...
5. **Present and ask** when ambiguity is high-stakes (Confusion Protocol in `references/writing-style-and-confusion-protocol.md`). Otherwise act minimally and flag what you skipped or assumed.
