...
135 bytes larger in total (71,950 always-on) because `generate_rules.py`
...
`src/copilot-cli/instructions` carries 8 rules and 71,815 bytes, matching
...
The always-on corpus is 8.8x that threshold and a Python edit sees 11.9x,
