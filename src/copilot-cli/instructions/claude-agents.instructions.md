...
3. **Skill tests**. New skills MUST include pytest coverage under `tests/skills/<name>/`. Tests are CI artifacts and MUST NOT ship inside customer skill directories.
