...
- If you cannot list `.project-toolkit/` or cannot determine whether AGENT-INSTRUCTIONS.md exists, stop and report `[BLOCKED] Cannot determine .project-toolkit scaffold ownership`.
