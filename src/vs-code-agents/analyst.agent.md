...
declared GitHub read tools (`pull_request_read`, `issue_read`,
`list_workflow_runs`, etc.) to retrieve structured data directly. The
analyst has no web access; do not attempt to fetch GitHub URLs over HTTP.
