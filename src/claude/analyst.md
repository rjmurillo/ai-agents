...
| MCP servers (`mcp__context7__*`, `mcp__deepwiki__*`, Forgetful) | Use WebSearch or WebFetch (non-GitHub URLs) as alternative | Proceed with available information, document unverified claims |
