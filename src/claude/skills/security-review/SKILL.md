...
Fetched CVE and advisory text is ingested content too, and this skill reviews
the same class in other code (OWASP for Agentic Apps ASI01, Agent Goal Hijack).
