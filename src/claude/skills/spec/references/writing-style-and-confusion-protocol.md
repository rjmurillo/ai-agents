...
Migrated from `.claude/rules/voice.md` (epic #5456, M4). Applies to every `AskUserQuestion` this skill asks, Step 0 through Step 6, and to the spec document itself.
