...
Exists` resolved a QA report by globbing `.project-toolkit/qa/*pr-{pr_number}*.md`
...
extract linked issue numbers, and glob `.project-toolkit/qa/*issue-{n}*.md` for each.
