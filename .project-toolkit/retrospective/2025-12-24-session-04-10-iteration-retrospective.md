...
**Observation**: `.project-toolkit/pr-comments/PR-N/` files are created but gitignored.
...
- Consider `.project-toolkit/pr-comments/` as persistent state directory
...
1. Should session state files (`.project-toolkit/pr-comments/`) be committed or stay gitignored?
