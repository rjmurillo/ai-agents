...
| T+3 | Created session log | .project-toolkit/sessions/YYYY-MM-DD-session-NN.json via session-init skill | [PASS] File created |
...
| T+8 | Manual session log fix to match canonical | .project-toolkit/sessions/... (checklist/evidence fields) | [PASS] Template aligned |
...
pwsh scripts/Validate-SessionJson.ps1 -SessionLogPath ".project-toolkit/sessions/[log].md"
...
```
Suggested filename: .project-toolkit/retrospective/2026-01-06-session-811-init-retro.md
```