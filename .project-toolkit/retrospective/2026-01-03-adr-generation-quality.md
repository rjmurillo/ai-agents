...
- File: `.project-toolkit/architecture/ADR-039-agent-model-cost-optimization.md`
- Created: 2026-01-03
- Status: Accepted
- Supersedes: ADR-002
...
3. **Produce evidence document**:
   - Location: `.project-toolkit/analysis/adr-{number}-research.md`
...
5. **Produce fact-check report**:
   - Location: `.project-toolkit/analysis/adr-{number}-fact-check.md`
...
5. **Produce critique**:
   - Location: `.project-toolkit/critique/adr-{number}-critique.md`
...
4. **Produce challenge report**:
   - Location: `.project-toolkit/critique/adr-{number}-challenge.md`
...
4. **Produce consensus report**:
   - Location: `.project-toolkit/critique/adr-{number}-debate.md`
...
- [ ] Evidence document exists at `.project-toolkit/analysis/adr-{number}-research.md`
...
- [ ] Fact-check report exists at `.project-toolkit/analysis/adr-{number}-fact-check.md`
- [ ] All claims verified PASS
- [ ] No discrepancies between ADR and evidence
- [ ] New claims (if any) have web search verification

**Phase 4 Exit Criteria**:
- [ ] Critique exists at `.project-toolkit/critique/adr-{number}-critique.md`
- [ ] Structure: PASS
- [ ] Logic: PASS
- [ ] Citations: PASS
- [ ] Consistency: PASS
...
- [ ] Challenge report exists at `.project-toolkit/critique/adr-{number}-challenge.md`
- [ ] Strategic reasoning challenged and addressed
- [ ] Alternatives challenged and addressed
- [ ] Impact challenged and addressed

**Phase 6 Exit Criteria**:
- [ ] Debate report exists at `.project-toolkit/critique/adr-{number}-debate.md`
...
|-----------|------|--------|
| git add | `.project-toolkit/retrospective/2026-01-03-adr-generation-quality.md` | Retrospective artifact |
