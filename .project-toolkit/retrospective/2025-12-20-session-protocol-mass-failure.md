...
- 24 session logs analyzed from `.project-toolkit/sessions/`
...
```powershell
# Should PASS
.\scripts\Validate-SessionEnd.ps1 -SessionLogPath ".project-toolkit/sessions/2025-12-20-session-44-security-remediation.md"

# Should FAIL
.\scripts\Validate-SessionEnd.ps1 -SessionLogPath ".project-toolkit/sessions/2025-12-20-session-46-skills-index-prd.md"
```
...
$sessionFile = ".project-toolkit/sessions/$date-session-$SessionNumber.md"
  ...
  validate:
    ...
    steps:
      ...
      - name: Validate Session Logs
        shell: pwsh
        run: |
          $sessions = Get-ChildItem .project-toolkit/sessions -Filter "*.md"
          $failures = @()
...
$sessions = Get-ChildItem .project-toolkit/sessions -Filter "2025-*.md"
...
$metrics | ConvertTo-Json | Out-File .project-toolkit/metrics/protocol-compliance.json
```
...
|-----------|------|--------|
| git add | `.project-toolkit/retrospective/2025-12-20-session-protocol-mass-failure.md` | This retrospective |
| git add | `.project-toolkit/retrospective/analyze-compliance.ps1` | Analysis script artifact |
...
- **Session 44**: `.project-toolkit/sessions/2025-12-20-session-44-security-remediation.md` (exemplar)
- **Session 46**: `.project-toolkit/sessions/2025-12-20-session-46-skills-index-prd.md` (false positive)
- **Prior Retrospective**: `.project-toolkit/retrospective/2025-12-17-protocol-compliance-failure.md`
- **Compliance Script**: `.project-toolkit/retrospective/analyze-compliance.ps1`
