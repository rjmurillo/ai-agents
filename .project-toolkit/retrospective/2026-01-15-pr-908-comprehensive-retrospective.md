...
|---------|-----------------|------------|
| Architect BLOCKED with P1 | `.project-toolkit/architecture/DESIGN-REVIEW-skill-reflect.md` | HIGH |
...
1. **Add synthesis panel structured format** (`.project-toolkit/architecture/DESIGN-REVIEW-template.md`):
