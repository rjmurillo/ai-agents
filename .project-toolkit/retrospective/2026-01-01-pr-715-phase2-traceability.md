...
- **Session Reference**: `.project-toolkit/sessions/2025-12-31-session-113-phase2-traceability.md`
...
| Timely | Y | Trigger: when adding diagrams to .agents/governance/ or .project-toolkit/architecture/ |
...
- Base: 100%
- Deductions: -15% (could specify "in .agents/governance/ and .project-toolkit/architecture/")
...
```json
{
  ...
  "statement": "Use Mermaid syntax for governance document diagrams instead of ASCII art",
  "context": "When adding diagrams to .agents/governance/ or .project-toolkit/architecture/ documents",
...
|-----------|------|--------|
| git add | `.project-toolkit/retrospective/2026-01-01-pr-715-phase2-traceability.md` | Retrospective artifact |
