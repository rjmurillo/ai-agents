...
1. Merge conflict on `.project-toolkit/sessions/` between our session 1188 and main's session 1188
...
| `.project-toolkit/sessions/*.json` | **CRITICAL**: Session files from main are NEVER altered. Always accept theirs, rename ours to next available number |

# What I did (WRONG):
git checkout --ours .project-toolkit/sessions/2026-02-08-session-1188.json

# What should have happened (CORRECT):
git checkout --theirs .project-toolkit/sessions/2026-02-08-session-1188.json
mv our_session.json .project-toolkit/sessions/2026-02-08-session-1189.json
```
...
| Timely | Y | Trigger: merge conflict on .project-toolkit/sessions/ |
...
```markdown
### Session Files (.project-toolkit/sessions/*.json)
...
git checkout --theirs .project-toolkit/sessions/YYYY-MM-DD-session-NNN.json
mv our_session.json .project-toolkit/sessions/YYYY-MM-DD-session-$(( NNN + 1 )).json
git add .project-toolkit/sessions/

# INCORRECT: Never alter main's session
git checkout --ours .project-toolkit/sessions/YYYY-MM-DD-session-NNN.json  # ❌ WRONG
```
...
|-----------|------|--------|
| git add | `.project-toolkit/retrospective/2026-02-08-session-1187-skip-prepush-abuse.md` | Retrospective artifact |
