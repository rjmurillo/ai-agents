...
|-------|-------------------|----------|
| Initial workflow creation (fa0dfbe) | Listed in session retrospective | `.project-toolkit/retrospective/2025-12-15-install-scripts-session.md` line 7 |
...
3. No security impact analysis document exists in `.project-toolkit/security/`
...
| Create workflow security checklist in `.project-toolkit/security/` | Medium | Security |
...
3. [ ] Add workflow security checklist to `.project-toolkit/security/`
