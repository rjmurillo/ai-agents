...
- Predecessor retro: `.project-toolkit/retrospective/2026-05-10-pr-1965-review-axes-convergence.md`
- PR #1887 retro (same cascade pattern, first occurrence): `.project-toolkit/retrospective/2026-05-05-pr-1887-iteration-paradox.md`
- Failure modes taxonomy: `.agents/governance/FAILURE-MODES.md`
- ADR-035 exit codes: `.project-toolkit/architecture/ADR-035-exit-code-standardization.md`
...
|---|---|---|
| git add | `.project-toolkit/retrospective/2026-05-10-pr-1989-recursive-failure.md` | Retrospective artifact |
