...
3. **Extract migration checklist**: Create reusable template in `.project-toolkit/planning/`
...
- Session Log: [Session 26](../sessions/2025-12-18-session-26-serena-memory-references.md)
- Analysis: `.project-toolkit/analysis/claude-vs-template-differences.md` (created during session)
