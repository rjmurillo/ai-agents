...
taken. `.project-toolkit/architecture/ADR-094-govern-copilot-cli-compatibility.md` was
accepted in PR #5024 and owns `.project-toolkit/critique/ADR-094-debate-log.md`. The
...
debate log to `.project-toolkit/critique/ADR-NNN-debate-log.md`, which forced an add/add
...
- `.project-toolkit/critique/ADR-095-debate-log.md`, the debate and its verification section.
