...
4. **FOURTH**: Read `.project-toolkit/planning/enhancement-PROJECT-PLAN.md` - project phases and tasks
```
...
- [ ] Read `.project-toolkit/planning/enhancement-PROJECT-PLAN.md` for current project
- [ ] Check `.agents/HANDOFF.md` for previous session notes
- [ ] Identify your assigned phase and tasks
- [ ] Create session log: `.project-toolkit/sessions/YYYY-MM-DD-session-NN.json`
```
...
- `.project-toolkit/retrospective/2025-12-17-session-failures.md`: Created Skill-Init-001 for Serena initialization ONLY
- `.project-toolkit/retrospective/2025-12-17-ci-test-failures.md`: No session protocol skills
...
8. **Pre-commit protocol hook** - Git hook verifies session log exists
   - Checks `.project-toolkit/sessions/YYYY-MM-DD-session-NN.json` exists
...
□ Create session log
  - Create .project-toolkit/sessions/YYYY-MM-DD-session-NN.json
...
- **This Retrospective**: `.project-toolkit/retrospective/2025-12-17-protocol-compliance-failure.md`
- **Session Log**: `.project-toolkit/sessions/2025-12-17-session-01-mcp-config-research.md`
- **Prior Retrospectives**:
  - `.project-toolkit/retrospective/2025-12-17-session-failures.md` (Serena init failure → Skill-Init-001)
  - `.project-toolkit/retrospective/2025-12-17-ci-test-failures.md`
- **Protocol Documents**:
