...
- Context to preserve: Document canonical formats in `.project-toolkit/analysis/` and update HANDOFF entries.
...
3. Update `.agents/HANDOFF.md` and add a short doc in `.project-toolkit/analysis/` to call out canonical formats.
...
4. Update README or add `.project-toolkit/analysis/001-mcp-sync-to-copilot.md` documenting the change and risks.
