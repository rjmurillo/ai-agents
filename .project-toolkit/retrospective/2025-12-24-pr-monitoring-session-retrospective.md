...
- **Tool error logging**: Create `.project-toolkit/retrospective/errors/` directory for capturing failed commands
...
| git add | `.project-toolkit/retrospective/2025-12-24-pr-monitoring-session-retrospective.md` | Retrospective artifact |
