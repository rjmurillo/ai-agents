...
`.project-toolkit/architecture/ADR-064-commands-to-skills-migration.md`. It decides
...
3. Why did the ADR index not surface it? Because it was never consulted.
   `AGENTS.md` names `.project-toolkit/architecture/README.md -> ADR-*.md` under
...
- `.project-toolkit/architecture/ADR-064-commands-to-skills-migration.md`. The decision, still `proposed`, `implemented: false`.
