...
`.project-toolkit/memory/episodes`, which holds 750 files.
...
- `d0d107839`: the correction, and the Round 2 section of
  `.project-toolkit/critique/ADR-106-debate-log.md`
...
- `.project-toolkit/critique/ADR-106-debate-log.md`: round 1, 6 seats, 3 ACCEPT /
