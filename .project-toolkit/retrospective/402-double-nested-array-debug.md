...
|-----------|------|--------|
| git add | `.project-toolkit/retrospective/402-double-nested-array-debug.md` | Retrospective artifact |
| git add | `.project-toolkit/sessions/2025-12-26-session-89-pr402-debug-retrospective.md` | Session log |
