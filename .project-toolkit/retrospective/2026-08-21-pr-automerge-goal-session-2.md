...
- **Task Type**: `/goal pr-automerge`, driving the repository's open PRs toward auto-merge. Second occurrence of this goal; the first is recorded in `.project-toolkit/retrospective/2026-08-19-pr-automerge-goal-session.md`.
