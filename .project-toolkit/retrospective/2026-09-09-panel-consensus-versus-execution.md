...
- `.project-toolkit/critique/ADR-072-jtbd-plugin-architecture-debate-log.md`, round 1
- `.project-toolkit/critique/ADR-100-101-enforcement-planes-debate-log.md`, round 12
