...
- The retrospective-policy hook requires either a `.project-toolkit/retrospective/` file or retrospective evidence patterns in the session log; session logs alone are not sufficient unless they contain the right keywords
