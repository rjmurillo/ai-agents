...
1. Fetched issue #5198 (generate `.project-toolkit/architecture/README.md` as an ADR
...
carries a generated `.project-toolkit/architecture/README.md`
(`git show origin/main:.project-toolkit/architecture/README.md`), the generator itself
