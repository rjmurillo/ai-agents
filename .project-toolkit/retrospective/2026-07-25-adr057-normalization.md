...
had also regenerated the memory episode and `.project-toolkit/memory/causality/causal-graph.json`,
...
- `.project-toolkit/analysis/ADR-057-workflow-ref-normalization-debate.md`: the debate log recording the two-lens panel and the justification for each omitted lens.
