...
Version: 1.0.0
Date: 2026-04-19
Related: [ADR-023](../architecture/ADR-023-quality-gate-prompt-testing.md), [testing-approach.md](../../.agents/steering/testing-approach.md)
...
| LLM interpretation, verdict correctness, regression proof | Behavioral evals (this doc) | `.project-toolkit/security/benchmarks/` or `tests/evals/` | Slow (minutes, API cost) | Probabilistic |
...
Use `.project-toolkit/security/benchmarks/test_agent_review_quality.py` as the scenario-based template. It documents the shape even though the test cases are currently skipped (pending Task tool integration). Copy its structure for new behavioral eval suites.
...
- [.project-toolkit/security/benchmarks/test_agent_review_quality.py](../security/benchmarks/test_agent_review_quality.py): Scenario-based test template.
