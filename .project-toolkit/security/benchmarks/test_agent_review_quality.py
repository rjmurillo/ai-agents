...
Run with: uv run pytest .project-toolkit/security/benchmarks/test_agent_review_quality.py -v
"""
...
class TestAgentReviewQuality:
    ...
    def test_review_completeness_all_findings_addressed(self) -> None:
        ...
        # 2. Parse .project-toolkit/security/SR-benchmark-*.md output
    ...
    def test_future_implementation_roadmap(self) -> None:
        ...
        implementation_plan = {
            ...
            "markdown_parsing": "Parse .project-toolkit/security/SR-*.md output files",
