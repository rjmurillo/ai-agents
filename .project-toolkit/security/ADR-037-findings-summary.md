...
- **Full Review**: `/home/claude/ai-agents/.project-toolkit/security/ADR-037-memory-router-security-review.md`
...
- **Project Security Standards**: `.project-toolkit/security/security-best-practices.md`
