...
| ADR-037 | `.project-toolkit/architecture/` | Design security |
...
| `.project-toolkit/architecture/ADR-037-memory-router-architecture.md` | 451 | Yes (design) |
| `.agents/governance/MEMORY-MANAGEMENT.md` | 489 | Documentation |
| `.project-toolkit/security/ADR-037-synchronization-security-review.md` | 200+ | Prior review |
