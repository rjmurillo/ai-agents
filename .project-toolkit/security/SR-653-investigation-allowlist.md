...
|---------|---------|-----------------|
| `^\.project-toolkit/sessions/` | Session logs | [PASS] |
| `^\.project-toolkit/analysis/` | Investigation outputs | [PASS] |
| `^\.project-toolkit/retrospective/` | Learnings | [PASS] |
| `^\.serena/memories($\|/)` | Cross-session context | [PASS] |
| `^\.project-toolkit/security/` | Security assessments | [PASS] |
...
- Current pattern `^\.project-toolkit/sessions/` requires trailing `/`
...
**Concern**: Could `.project-toolkit/sessions/../../../etc/passwd` match the pattern?
