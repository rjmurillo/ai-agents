...
The plan and spec live under .project-toolkit/plans/active/ and .project-toolkit/specs/requirements/. The ADR amendment is .project-toolkit/architecture/ADR-006-thin-workflows-testable-modules.md (Round 1, 2, and 3 amendments).
