...
```
scripts/metrics/control_plane_baseline.py --repo <repo> --json .project-toolkit/metrics/control-plane-baseline-v0.7.0.json --markdown .project-toolkit/metrics/control-plane-baseline-v0.7.0.md
```
