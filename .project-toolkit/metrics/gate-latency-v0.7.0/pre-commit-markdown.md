...
```
scripts/metrics/gate_latency.py --hook pre-commit --change-class markdown --repetitions 3 --json .project-toolkit/metrics/gate-latency-v0.7.0/pre-commit-markdown.json --markdown .project-toolkit/metrics/gate-latency-v0.7.0/pre-commit-markdown.md --allow-dirty
```
