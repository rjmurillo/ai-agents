...
baseline_path: .project-toolkit/metrics/control-plane-baseline-v0.7.0.json
created: 2026-09-11
status: draft
---
...
(`.project-toolkit/metrics/control-plane-baseline-v0.7.0.json`, not yet merged to
...
- Owner: ADR-099 (`.project-toolkit/architecture/ADR-099-remove-commit-limit-bypass-gate.md`)
...
- Evidence: `baseline-53ffe92c2.json`'s `command` field records
  ...
  `.project-toolkit/metrics/control-plane-baseline-v0.7.0.json` and
  `.project-toolkit/metrics/control-plane-baseline-v0.7.0.md`. This script does
...
(`.project-toolkit/audit/2026-09-04-ponytail-audit-over-engineering.md`), re-verified
...
- Evidence: no root `package.json` or `tsconfig.json` covers `src/*.ts` or
  ...
  `.project-toolkit/critique/ADR-107-debate-log.md` to satisfy
