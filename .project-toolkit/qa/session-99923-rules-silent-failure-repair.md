---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-21-session-99923-2dd747176-rules-silent-failure-repair.json
...
- Session log: `.project-toolkit/sessions/2026-08-21-session-99923-2dd747176-rules-silent-failure-repair.json`
...
p = glob.glob('.project-toolkit/memory/episodes/episode-*-rules-silent-failure-repair.json')[0]
d = json.load(open(p))
