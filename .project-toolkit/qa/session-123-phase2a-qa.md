...
| ADR-037 | [PASS] | `.project-toolkit/architecture/ADR-037-memory-router-architecture.md` |
| Analysis | [PASS] | `.project-toolkit/analysis/123-phase2a-memory-architecture-review.md` |
