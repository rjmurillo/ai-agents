---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-21-session-99926-a1b2c3d4e-pr-automerge-goal.json
...
`.project-toolkit/sessions/`, `.project-toolkit/qa/`, and `.project-toolkit/retrospective/`; no source
