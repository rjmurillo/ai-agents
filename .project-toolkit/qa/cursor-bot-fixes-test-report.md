...
**Test Case 2: Excluded Path (.project-toolkit/planning/123-feature.md)**

Current fix (`any-glob-to-any-file`):
```yaml
- any-glob-to-any-file:
    - "**/*.md"           # .project-toolkit/planning/123-feature.md matches ✓
    - "!.agents/**/*.md"  # .project-toolkit/planning/123-feature.md matches negation ✓
```
