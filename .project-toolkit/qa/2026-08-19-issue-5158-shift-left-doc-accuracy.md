---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-19-session-99919-bf1cf3993-analyze-pre-push-hook-duration-dora.json
...
- **Session log**: `.project-toolkit/sessions/2026-08-19-session-99919-bf1cf3993-analyze-pre-push-hook-duration-dora.json`
- **Scope**: `.project-toolkit/devops/SHIFT-LEFT.md`, 682 lines to 320
...
`docs/WORKFLOW-VALIDATION.md`, `.project-toolkit/devops/validation-runner-pattern.md`,
...
`[ERROR] authored file-size: .project-toolkit/devops/SHIFT-LEFT.md:682` and the count
