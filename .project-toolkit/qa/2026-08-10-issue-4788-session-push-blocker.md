...
- `.project-toolkit/sessions/2026-08-08-session-10018-b2f6a78e7-fix-issue-3912-authoritative-github.json`
- `.project-toolkit/qa/pr-4767-issue-3912-authoritative-pr-context-test-report.md`
...
| PR helper tests | 86 passed |
| Skill mirror generation | canonical and Copilot copies match |
| Ref-backed session identity tests | 2 passed |
