---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-15-session-14713-issue-5096-qa-report-issue-fallback.json
qaCommit: d95972998d3cc4915afb2a9178c2423e7f14f9ef
---
...
`.project-toolkit/qa/*pr-{pr_number}*.md` only. A PR number does not exist until the PR
...
`.project-toolkit/qa/*issue-{n}*.md` per number in that order and skips a candidate
...
`.project-toolkit/qa/issue-5096-qa-report-issue-fallback.md`, ran the full
