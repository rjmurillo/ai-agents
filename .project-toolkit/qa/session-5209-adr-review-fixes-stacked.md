---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-21-session-5209-14a6f1844-adr-review-fixes-stacked.json
...
`.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`, whose addenda 5 and 6 carry
...
`.project-toolkit/critique/ADR-005-status-duplication-debate-log.md:77` stays held: what
...
lands, and this addendum's own commit touches only `.project-toolkit/qa/*.md`, an
...
`.project-toolkit/architecture/README.md` had not been regenerated after the merge
...
diff is exactly the two new ADR rows, nothing else. `.project-toolkit/architecture/README.md`
...
2. **A real taste-count ratchet regression**: 577 violations against
   ...
   `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md` crossing 500 lines
...
`.project-toolkit/architecture/README.md` and these two QA reports. Only the two QA
...
`.project-toolkit/architecture/README.md` was one of the three files `merge-tree`
...
This addendum's own commit touches only `.project-toolkit/qa/*.md`, an evidence
...
`scripts/utils/markdown_parser.py`, `.project-toolkit/architecture/ADR-TEMPLATE.md`),
...
touched files: the two QA reports and `.project-toolkit/architecture/README.md`) as "a
...
exactly `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md` and
`.project-toolkit/qa/session-5209-adr-review-fixes-stacked.md`, and no others.
...
following, touches only `.project-toolkit/qa/session-5209-adr-review-fixes-stacked.md`
...
Full detail in Addendum 19 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`:
...
Full detail in Addendum 20 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`:
...
Full detail in Addendum 21 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`.
...
Full detail in Addendum 22 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`.
...
Full detail in Addendum 23 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`.
...
Full detail in Addendum 24 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`.
...
`.project-toolkit/architecture` for unrelated `build_all.py` tests, which now
...
Same merge as Addendum 27 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`;
...
Same defect as Addendum 28 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`;
...
Same merge as Addendum 30 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`;
...
(`.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`): `origin/main` merged
...
(`.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`); full detail,
...
(`.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`); full detail lives
...
(`.project-toolkit/architecture/ADR-073-adr-lifecycle-frontmatter.md:49`,
