---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-10-session-14653-bddf96dac-github-issue-4853-end-end.json
...
- Full-tree Ruff remains red on unrelated files under `.project-toolkit/analysis`.
