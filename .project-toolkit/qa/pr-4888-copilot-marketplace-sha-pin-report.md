---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-11-session-14685-pr-autofix-4888.json
...
- Confirmed the fix contract against two sources this session, not from
  ...
  - In-repo: `.project-toolkit/security/ADR-045-framework-extraction-security-review.md`,
...
`ref` + `sha` pattern shown in `.project-toolkit/analysis/claude-code-plugin-marketplaces.md`,
