---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-21-session-99928-b3f7a91c2-remove-commit-limit-bypass-gate.json
...
8. `.project-toolkit/architecture/ADR-099-remove-commit-limit-bypass-gate.md` and
   its debate log at `.project-toolkit/critique/ADR-099-debate-log.md`.
