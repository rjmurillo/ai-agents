---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-12-session-14695-b47f72afe-amend-adr-080-measured-copilot-model.json
...
- Episode `files_changed` is the schema-valid integer 5, matching `git show
  ...
  `1e0a6a775`, `0edf6e063`): `.project-toolkit/analysis/2026-08-12-adr-080-copilot-model-resolution.md`,
  `.project-toolkit/architecture/ADR-080-model-pin-justification-policy.md`,
  `.project-toolkit/critique/ADR-080-amendment-2026-08-12-debate-log.md`, this
...
- Round-3 fix: `scripts/ci/validate_session_protocol.py --session-file
  ...
  .project-toolkit/analysis/2026-08-12-adr-080-copilot-model-resolution.md" once
...
- Round-5 fix: a still-open review thread on the `42ce51f50` review (an
  ...
  This fix touches only `.project-toolkit/memory/episodes/`, `.project-toolkit/sessions/`,
  and `.project-toolkit/qa/` paths (all `QA_EVIDENCE_PREFIXES`), so it does not
