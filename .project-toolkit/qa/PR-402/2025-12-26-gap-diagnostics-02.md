...
**Location**: `.project-toolkit/architecture/bot-author-feedback-protocol.md`, lines 227-240
...
| `.project-toolkit/architecture/bot-author-feedback-protocol.md` | MODIFY | Glossary: clarify acknowledged vs resolved |
