...
**Command**: `ls .project-toolkit/architecture/ADR-*.md | sort`
...
**Verification**: `grep -n "ADR-014" .project-toolkit/architecture/ADR-024-github-actions-runner-selection.md` returns 0 results
...
```bash
$ git show cf11306:.project-toolkit/architecture/ADR-022-architecture-governance-split-criteria.md | grep -n "ADR-014.*runner"
