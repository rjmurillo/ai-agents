---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-14-session-4987-lease-store-qa.json
...
- `uv run --frozen python scripts/validate_session_json.py .project-toolkit/sessions/2026-08-14-session-4987-lease-store-qa.json`
