...
**Command**:
```bash
pwsh scripts/Validate-SessionEnd.ps1 -SessionLogPath ".project-toolkit/sessions/2025-12-30-session-104-reconcile-session-validation.md"
```
...
Fail: E_QA_EVIDENCE: QA row checked but Evidence missing QA report path under .project-toolkit/qa/.
```
...
**Command**:
```bash
pwsh scripts/Validate-SessionEnd.ps1 -SessionLogPath ".project-toolkit/sessions/2025-12-30-session-100-phase1-spec-layer.md"
```
