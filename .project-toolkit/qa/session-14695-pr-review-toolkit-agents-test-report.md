...
`.project-toolkit/sessions/2026-08-13-session-14695-....json` file sitting in the
...
`uv run python scripts/validate_session_json.py .project-toolkit/sessions/2026-08-13-session-14695-b1cdc6d2e-implement-technology-agnostic-review-agents-based.json`
exits 1:
