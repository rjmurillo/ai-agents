---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-18-session-5154-b6c2a2eed-retire-three-tool-use-hooks-vendored.json
...
`.project-toolkit/critique/ADR-084-rule-6-tool-use-bar-debate-log.md`. Four were defects
...
- Orphan-ref scan reports `VERDICT: CRITICAL_FAIL` with 6 findings. All six are
  ...
  `.project-toolkit/specs/tasks/TASK-015-pr-iteration-cost.md`, following the
