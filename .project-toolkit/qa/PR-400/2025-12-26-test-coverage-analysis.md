...
| Should include sessions directory | [PASS] | `.project-toolkit/sessions/*` pattern |
...
- [ ] Test that `.project-toolkit/planning/PRD-001.md` matches pattern (should auto-resolve)
...
Context 'Behavioral Tests - Auto-Resolution Pattern Matching' {
    It 'Should auto-resolve .agents subdirectory files' {
        Test-IsAutoResolvable -FilePath '.project-toolkit/planning/PRD-001.md' | Should -Be $true
    }
...
- Gap 1-4: See `.project-toolkit/qa/PR-402/2025-12-26-gap-diagnostics.md`
