---
qaVerdict: PASS
qaSessionLog: .project-toolkit/sessions/2026-08-19-session-99921-b9d55af7c-retire-pretooluseposttooluseposttoolusefailure-hooks-windowsdefender-per-spawn.json
...
failure was this QA report's own staleness check (`.project-toolkit/qa/`, `.project-toolkit/sessions/`,
and `.project-toolkit/memory/episodes/` are QA-evidence-exempt paths, so rebinding
