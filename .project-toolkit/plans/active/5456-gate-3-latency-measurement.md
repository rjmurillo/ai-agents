...
- `.project-toolkit/metrics/gate-latency-v0.7.0.json` and `.md` committed, carrying
...
- The gate 3 row in `.project-toolkit/metrics/control-plane-dispositions-v0.7.0.md`
...
- The baseline's "no sampler exists" exclusion is answered in the ledger, with
  `.project-toolkit/metrics/control-plane-baseline-v0.7.0.json` left untouched, because
