...
Exit criteria: `check_adr_lifecycle.py` passes; `adr-review` round recorded at `.project-toolkit/critique/ADR-108-debate-log.md` with every P0 and P1 resolved or deferred with an issue; `build_all.py --check` exits 0 after the ADR index regenerates; PR open with `Refs #5706`.
