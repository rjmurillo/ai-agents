...
- **ADR-040**: Skill Frontmatter Standardization (`.project-toolkit/architecture/ADR-040-skill-frontmatter-standardization.md`)
- **Analysis**: Claude Code Skill Frontmatter 2026 (`.project-toolkit/analysis/claude-code-skill-frontmatter-2026.md`)
- **Analysis**: agentskills.io Standard (`.project-toolkit/analysis/agentskills-io-standard-2026-01.md`)
