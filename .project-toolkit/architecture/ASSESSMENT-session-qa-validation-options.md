...
Checks staged files at commit time rather than branch history. If staged files are only `.project-toolkit/sessions/*.md` and `.serena/memories/*.md`, skip QA requirement.
