...
1. Create `.project-toolkit/architecture/DESIGN-REVIEW-template.md` with frontmatter and body sections
...
- `.project-toolkit/architecture/ADR-040-skill-frontmatter-standardization.md` (frontmatter pattern reference)
- `.project-toolkit/retrospective/2026-01-15-pr-908-comprehensive-retrospective.md` (incident analysis)
