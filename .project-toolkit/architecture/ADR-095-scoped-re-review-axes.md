...
`.project-toolkit/architecture/ADR-094-govern-copilot-cli-compatibility.md`, accepted in
PR #5024, which also owns `.project-toolkit/critique/ADR-094-debate-log.md`. This
record's debate log is `.project-toolkit/critique/ADR-095-debate-log.md`.
...
2. **The signal figure was spliced from two rollups of one source.**
   `.project-toolkit/analysis/009-phase1-agent-comment-baseline.md:163` reports 182
...
`.project-toolkit/critique/ADR-095-debate-log.md`. Six roles, one round, no consensus:
...
- `.project-toolkit/critique/ADR-095-debate-log.md`. The debate.
- PR #5010, `458028d2b`. Risk-based axis selection, the approach that shipped.
- `.project-toolkit/analysis/009-phase1-agent-comment-baseline.md`. The signal baseline finding 2 refers to.
