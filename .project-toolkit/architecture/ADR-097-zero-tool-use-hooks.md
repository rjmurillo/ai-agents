...
`.project-toolkit/critique/ADR-097-debate-log.md`.
...
`.project-toolkit/specs/hook-protocol.md:55` names it as a live pipeline component
...
| `CONTRIBUTING.md`, `.claude/skills/ai-agents-architecture-contract/`, `.claude/skills/ai-agents-config-catalog/`, `.claude/skills/agent-harness-reference/`, `.claude/hooks/PostToolUse/README.md` (calls `observation_sync` a "reference implementation for simple hooks"), `.project-toolkit/specs/hook-protocol.md` | Indirect | Prose referencing any of the 5 retired hooks, `.github/hooks/require-subagent-model.json`, or the Copilot dispatcher as live needs updating | Low: documentation drift, not functional risk |
...
as of this ADR (see
`.project-toolkit/sessions/handoffs/2026-08-19-tool-use-hook-retirement-handoff.md`
