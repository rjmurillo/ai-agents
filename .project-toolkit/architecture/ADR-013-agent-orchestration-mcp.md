...
interface AgentDefinition {
  ...
  artifact_directory?: string;     // e.g., ".project-toolkit/analysis/"
}
  ...
  "invocations": [
    {
      ...
      "duration_ms": 45000,
      "artifacts_created": [".project-toolkit/analysis/api-latency.md"]
    }
  ],
  "handoffs": [
    {
...
- [AGENT-SYSTEM.md](../../.agents/AGENT-SYSTEM.md) - Agent catalog and workflows
