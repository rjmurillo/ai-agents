...
REQ-017 (`.project-toolkit/specs/requirements/REQ-017-spec-memory-first-gate.md`, issue
...
(`.project-toolkit/sessions/STEP-0.5-METRICS.md`), and adds a cross-step state-passing
...
(`.project-toolkit/retrospective/2026-05-05-pr-1887-iteration-paradox.md`). Step 0.5's
...
> Decision Record in `.project-toolkit/architecture/`.
...
- REQ-017 is the requirement of record for the gate behavior. It carries 13
  ...
  the gate does.
- `.project-toolkit/architecture/ADR-007-memory-first-architecture.md` declares the
...
- `.project-toolkit/architecture/ADR-007-memory-first-architecture.md`: declares
...
- `.project-toolkit/specs/requirements/REQ-017-spec-memory-first-gate.md`: the
...
- `.project-toolkit/retrospective/2026-05-05-pr-1887-iteration-paradox.md`: the cost
...
`REQ-016-13` in
`.project-toolkit/specs/requirements/REQ-016-spec-step0-first-principles-gate.md`)
...
| `.project-toolkit/specs/requirements/REQ-017-spec-memory-first-gate.md` Dependencies | Direct | Cite this ADR (separate work-item; not this PR) | Low |
...
- `.project-toolkit/specs/requirements/REQ-017-spec-memory-first-gate.md`: gate behavior
  source of truth (AC-01 through AC-13)
- `.project-toolkit/retrospective/2026-05-05-pr-1887-iteration-paradox.md`: cost evidence
