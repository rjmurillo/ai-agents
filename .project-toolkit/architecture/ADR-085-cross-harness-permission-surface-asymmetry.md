...
`.project-toolkit/analysis/ADR-085-permission-surface-debate.md`. The superseding
security-amendment review reached consensus with 5 Accept plus 1
Disagree-and-Commit and no unresolved P0. Its record is
`.project-toolkit/critique/ADR-085-debate-log.md`. The owner initially ratified D-A as
...
(debate log `.project-toolkit/critique/ADR-068-071-085-metric-refresh-debate-log.md`).
...
`.project-toolkit/critique/ADR-068-071-085-5013-debate-log.md`. Sources:
...
`.project-toolkit/architecture/ADR-084-vendored-hook-roi-bar.md ("What this ADR does NOT do")` forbids it:
...
Debate log: `.project-toolkit/critique/ADR-068-071-085-5013-debate-log.md`.
...
`.project-toolkit/architecture/ADR-084-vendored-hook-roi-bar.md ("What this ADR does NOT do")` states: "It
...
`.project-toolkit/critique/ADR-084-debate-log.md:17` says the opposite: it credits a
...
- `.project-toolkit/critique/ADR-084-debate-log.md:17`, the reviewer verification that
...
- `.project-toolkit/audits/2026-07-02-safety-audit.md`, findings 19 and 48.
...
- `.project-toolkit/critique/ADR-068-071-085-5013-debate-log.md`, the issue #5013
