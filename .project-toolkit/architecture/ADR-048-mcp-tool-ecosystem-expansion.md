...
Analysis of claude-flow (`.project-toolkit/analysis/claude-flow-architecture-analysis.md`) shows their ecosystem includes 100+ MCP tools across categories: Swarm Coordination, Neural Networks, Memory, Analysis, GitHub Integration, and Workflow Automation.
...
| Metrics Storage | JSON files in `.project-toolkit/metrics/` |
