...
|--------|----------|--------|-------------|
| EARS adoption rate | 0% | 100% of new specs | Audit `.project-toolkit/specs/requirements/` |
...
- Formal requirement specifications in `.project-toolkit/specs/`
...
- [EARS Format Template](../../.agents/governance/ears-format.md) - Project implementation
