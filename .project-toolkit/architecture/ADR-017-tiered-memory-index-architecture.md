...
- [PRD-skills-index-registry.md](../../.agents/archive/planning/PRD-skills-index-registry.md): Superseded flat registry approach
...
- `.project-toolkit/critique/017-tiered-memory-index-critique.md`: 5-agent review
- `.project-toolkit/analysis/083-adr-017-quantitative-verification.md`: Token calculations
