...
|------|----------|--------------|-----------|---------|
| **Tier 1** (Session) | `.project-toolkit/sessions/YYYY-MM-DD-session-NN.json` | 2K per session | Permanent | Complete session record |
| **Tier 2** (Branch) | `.project-toolkit/handoffs/{branch}/` | 3K per branch | Deleted on merge | Branch coordination (optional) |
...
.project-toolkit/handoffs/*.md merge=handoff-aggregate
```
...
3. Delete `.project-toolkit/handoffs/` directory
