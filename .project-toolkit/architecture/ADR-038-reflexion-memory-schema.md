...
│               (NEW: .project-toolkit/memory/episodes/)                │
└───────────────────────────┬─────────────────────────────────┘
                            │
┌───────────────────────────▼─────────────────────────────────┐
│                    Causal Memory (Tier 3)                    │
│        Cause-effect graphs, counterfactual analysis          │
│              (NEW: .project-toolkit/memory/causality/)                │
└─────────────────────────────────────────────────────────────┘
```
...
**Storage**: `.project-toolkit/memory/episodes/{session-id}.json`
...
**Storage**: `.project-toolkit/memory/causality/causal-graph.json`
...
```text
Session Log (.project-toolkit/sessions/*.md)
         │
         ▼
┌─────────────────────────────┐
...
└─────────────────────────────┘
         │
         ▼
Episode JSON (.project-toolkit/memory/episodes/*.json)
         │
         ▼
┌─────────────────────────────┐
...
└─────────────────────────────┘
         │
         ▼
Causal Graph (.project-toolkit/memory/causality/causal-graph.json)
```
...
1. Create `.project-toolkit/memory/episodes/` directory structure
2. Create `.project-toolkit/memory/causality/` directory structure
...
- Phase 2A Gap Analysis: `.project-toolkit/analysis/123-phase2a-memory-architecture-review.md`
