...
**Created**:
- `.project-toolkit/architecture/ADR-041-codeql-integration.md` (this ADR)
...
4. Store this review in `.project-toolkit/architecture/ADR-041-REVIEW.md`

---

## References

- [ADR-041: CodeQL Integration Multi-Tier Strategy](./.project-toolkit/architecture/ADR-041-codeql-integration.md)
