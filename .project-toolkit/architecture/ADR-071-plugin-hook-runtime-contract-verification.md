...
fail-closed position. Debate log: `.project-toolkit/critique/ADR-071-debate-log.md`.
...
`.project-toolkit/critique/ADR-068-071-085-metric-refresh-debate-log.md`).
**Retired by ADR-097.**
...
`.project-toolkit/critique/ADR-068-071-5061-debate-log.md`.
...
bar, which `.project-toolkit/architecture/ADR-084-vendored-hook-roi-bar.md ("What this ADR does NOT do")`
...
`.project-toolkit/retrospective/2026-06-02-pr-2205-customer-wedge-incident.md`) exposed a
...
above. Debate log: `.project-toolkit/critique/ADR-068-071-085-5013-debate-log.md`.
...
- `.project-toolkit/critique/ADR-071-debate-log.md`. Six-agent review debate.
