...
The "Any Decision Record" movement has expanded ADR usage from strictly architectural decisions to include design, process, tool selection, and governance decisions. This creates ambiguity about what belongs in `.project-toolkit/architecture/` vs `.agents/governance/`.
...
1. **`.project-toolkit/architecture/`** - ADRs with architectural significance
...
- **ADR template**: `.project-toolkit/architecture/ADR-TEMPLATE.md` (create)
...
- Codebase: `.project-toolkit/architecture/` (ADR catalog)
...
**Placement**: `.project-toolkit/architecture/ADR-019-api-authentication-strategy.md`
...
**Placement**:
- `.project-toolkit/architecture/ADR-020-database-migration-strategy.md`
