...
single file at `.project-toolkit/memory/causality/causal-graph.json`, written by
...
`.project-toolkit/memory/episodes/episode-2026-07-25-session-3345-causal-graph-merge-driver.json`.
