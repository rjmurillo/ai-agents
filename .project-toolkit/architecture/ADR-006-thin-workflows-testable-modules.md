...
**Related**: [ADR-005](./ADR-005-powershell-only-scripting.md) (PowerShell-Only Scripting), [PR #60 Remediation Plan](../../.agents/archive/planning/PR-60/002-pr-60-remediation-plan.md)
...
- [ ] Tests can run locally: `uv run pytest tests/`
...
- [Session log](../sessions/2025-12-18-session-15-pr-60-response.md): `.project-toolkit/sessions/2025-12-18-session-15-pr-60-response.md`
...
- Spec: `.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md`
- Plan: `.agents/archive/plans/req-003-multi-tool-artifact-build.md`
- Regression that motivated REQ-003: `.project-toolkit/incidents/2026-04-27-pir-plugin-manifest-schema-1773.md`
