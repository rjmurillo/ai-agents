...
|---|---|---|
| REQ-003-010 | `.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md:358-359` | "The build shall never write to `.claude/<artifact>/` or `.claude/settings.json`." (`docs-say`) |
...
| `.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md:358-361` (`The build shall never write`, `Verification:`) | Direct | Exception clause in the requirement sentence and the verification sentence, plus a dated note. | Low |
| `.project-toolkit/architecture/ADR-107-canonical-skill-contracts-and-harness-projections.md:61-62` (`They never write under`) and its Related Decisions | Direct | Exception clause in property 1; re-anchored guard line numbers; one Related Decisions bullet. | Low |
...
| `.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md:80` (D4) | Direct | Exception clause | Low |
...
- `.project-toolkit/specs/requirements/REQ-025-skill-guidance-excerpts.md`, `.project-toolkit/specs/design/DESIGN-024-skill-guidance-excerpt-sync.md`, `.project-toolkit/plans/active/5706-skill-guidance-excerpts.md`.
