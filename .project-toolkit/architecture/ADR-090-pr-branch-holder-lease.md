...
# ADR-090: PR Branch Holder Lease
...
|-----------|-----------------|-----------------|------|
| `.project-toolkit/architecture/ADR-076-pr-autofix-branch-ownership-lease.md` | Direct | Treat this ADR as an amendment for self-renewal, fail-closed mutation, expiry, and override semantics. | Medium |
...
- `.project-toolkit/architecture/ADR-076-pr-autofix-branch-ownership-lease.md`
