...
|-------|:----:|:----:|:------:|:-------:|-----------|
| analyst | ✓ | ✓ | ✓ | ✗ | Research + write findings to `.project-toolkit/analysis/` |
| architect | ✓ | ✓ | ✓ | ✗ | ADR/doc creation, no execution |
| critic | ✓ | ✓ | ✓ | ✗ | Review + write critiques to `.project-toolkit/critique/` |
...
| retrospective | ✓ | ✓ | ✓ | ✗ | Review + write retrospectives to `.project-toolkit/retrospective/` |
| roadmap | ✓ | ✓ | ✗ | ✗ | Strategic document creation |
| security | ✓ | ✓ | ✓ | ✗ | Security audit + write findings to `.project-toolkit/security/` |
...
- `critic` → `.project-toolkit/critique/`
- `high-level-advisor` → `.project-toolkit/planning/` (advisories)
- `retrospective` → `.project-toolkit/retrospective/`
- `security` → `.project-toolkit/security/`
