...
(`.project-toolkit/analysis/ADR-080-model-pin-policy-debate.md`) treated this as the
decisive finding.
...
- `.project-toolkit/analysis/ADR-080-model-pin-policy-debate.md` (the review this ADR
  incorporates)
