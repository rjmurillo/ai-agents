...
- `.project-toolkit/architecture/`: ADRs and architectural decisions
...
| `.project-toolkit/architecture/` (other ADRs) | Indirect | None now; ADRs that touch context sources should cite ADR-069 | Low |
...
- ADR-TEMPLATE.md: `.project-toolkit/architecture/ADR-TEMPLATE.md`.
