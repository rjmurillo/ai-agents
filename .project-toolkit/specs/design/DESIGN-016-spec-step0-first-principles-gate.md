...
- State the kill criteria reference (REQ-006-13): "Step 0 is subject to review at 30 invocations against kill criteria documented in REQ-006-13. A tally is kept in `.project-toolkit/sessions/STEP-0-METRICS.md` (one line per invocation). Absence of the file does not block `/spec`."
...
**Location**: `.project-toolkit/architecture/ADR-060-spec-step0-first-principles-gate.md`
