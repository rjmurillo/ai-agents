...
| Evidence matrix | Record source facts, local overlap, decision, and citation | `.project-toolkit/analysis/` |
...
Threat model: `.project-toolkit/security/threat-models/TM-aspire-skill-review.md`.
...
Write the harness's raw report under `.project-toolkit/scratch/`. Produce the durable
