...
- `.project-toolkit/specs/` (recursive)
...
`.project-toolkit/architecture/` and `docs/` are excluded from the default scan. Both
...
Real orphans inside `.project-toolkit/architecture/` (deleted skills referenced in
