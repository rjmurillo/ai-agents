...
`.project-toolkit/specs/requirements/REQ-029-serena-workflows-to-skills-and-agents.md`.
...
`.project-toolkit/analysis/5393-serena-workflow-inventory.md`: class, existing owner,
