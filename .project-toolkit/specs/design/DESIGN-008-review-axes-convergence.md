...
REQ-008-01 through REQ-008-08. Resolves drift between `/review` local evaluation and CI `ai-pr-quality-gate.yml` discovered via retrospective `.project-toolkit/retrospective/2026-05-05-pr-1887-iteration-paradox.md`.
