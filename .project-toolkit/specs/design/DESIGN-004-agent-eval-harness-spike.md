...
| `.project-toolkit/architecture/ADR-057-prompt-behavioral-evaluation.md` | CROSS-REF: different question; cite in ADR-NNN |
...
- OQ-6: ADR at `.project-toolkit/architecture/ADR-NNN-agent-eval-discipline.md`
