...
- Adding `.project-toolkit/memory/episodes/` to `_REWORK_EXCLUDED_PREFIXES` in the canonical script
...
- [ ] pytest reports 0 failures on `tests/skills/session-end/test_rework_warning.py` <!-- orphan-ref-ignore -->
- [ ] At least one warning line appears when M4 runs against the working branch before the milestone commit
- [ ] The mirror file `src/copilot-cli/skills/session-end/scripts/rework_warning.py` is regenerated (not hand-edited) to include the new prefix <!-- orphan-ref-ignore -->
...
| File | Action | Description |
|---|---|---|
| `tests/skills/session-end/test_rework_warning.py` | Modify | Add one test case using the fixture from TASK-010-01 <!-- orphan-ref-ignore --> |
...
Add `.project-toolkit/memory/episodes/` to `_REWORK_EXCLUDED_PREFIXES` in the canonical script. The test from TASK-010-02 turns green.

### Files Affected

| File | Action | Description |
|---|---|---|
| `.claude/skills/session-end/scripts/rework_warning.py` | Modify | Append `.project-toolkit/memory/episodes/` to `_REWORK_EXCLUDED_PREFIXES` <!-- orphan-ref-ignore --> |
...
Commit message: `fix(session-end): add .project-toolkit/memory/episodes/ to rework exclusion list`
...
| File | Action | Description |
|---|---|---|
| `src/copilot-cli/skills/session-end/scripts/rework_warning.py` | Modify (generated) | Regenerated by `build_all.py`; gains the episodes prefix <!-- orphan-ref-ignore --> |
