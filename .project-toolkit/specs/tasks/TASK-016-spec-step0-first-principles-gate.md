...
- Optional: write `.project-toolkit/architecture/ADR-060-spec-step0-first-principles-gate.md`
...
**Acceptance Criteria**:
- [ ] File exists at `.project-toolkit/architecture/ADR-060-spec-step0-first-principles-gate.md`.
- [ ] Status: Proposed.
...
| File | Action | Description |
|---|---|---|
| `.project-toolkit/architecture/ADR-060-spec-step0-first-principles-gate.md` | Create | New ADR |
