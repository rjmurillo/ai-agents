...
- [ ] Hook activates only when changeset includes files matching `.project-toolkit/sessions/*.json`.
...
- [ ] Returns 0 immediately when no `.project-toolkit/sessions/*.json` in changeset.
- [ ] All tests pass. Coverage >= 80%.
