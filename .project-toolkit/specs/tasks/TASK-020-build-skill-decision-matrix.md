...
|---|---|---|
| `.project-toolkit/analysis/aspire-skill-review-matrix.md` | Create | Human-readable decision matrix |
| `.project-toolkit/analysis/aspire-skill-review-matrix.json` | Create | Machine-readable decisions and scores |

## Implementation Notes

Consume `.project-toolkit/analysis/aspire-skill-source-files.json` from TASK-019 as the
