...
|---|---|---|
| `.project-toolkit/analysis/aspire-skill-source-inventory.md` | Create | Commit-pinned source inventory |
| `.project-toolkit/analysis/aspire-skill-source-files.json` | Create | Machine-readable skill IDs, roots, paths, and hashes |
...
TASK-020 consumes `.project-toolkit/analysis/aspire-skill-source-files.json` to reconcile
