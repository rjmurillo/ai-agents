...
| `.project-toolkit/scratch/aspire-skill-review-<run-id>-raw.json` | Create temporarily | Raw harness output, never committed |
| `.project-toolkit/analysis/aspire-skill-review-eval-<run-id>.json` | Create | Sanitized score and gate summary |
| `.project-toolkit/analysis/aspire-skill-review-eval-<run-id>.md` | Create | Human-readable sanitized result |
