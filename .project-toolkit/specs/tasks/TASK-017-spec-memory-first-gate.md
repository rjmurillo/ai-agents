...
- [ ] Metrics tally directive is stated: append one line to `.project-toolkit/sessions/STEP-0.5-METRICS.md` on every completion; format `<ISO-8601> | <pass|fail> | <trigger-or-none> | <check-or-none>`; absence of file does not block `/spec` (AC-11).
