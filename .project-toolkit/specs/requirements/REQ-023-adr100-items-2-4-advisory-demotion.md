...
ADR-100 (`.project-toolkit/architecture/ADR-100-retire-pr-size-ceilings.md`), an
...
(`.project-toolkit/retrospective/2026-08-07-pr-4402-scope-bypass.md`, cited directly
...
to exclude `.project-toolkit/sessions/**`, `.project-toolkit/qa/**`, and
`.project-toolkit/memory/episodes/**` (item 3); remove `SKIP_SCOPE_CHECK` in the same
...
retrospective `.project-toolkit/retrospective/2026-08-07-pr-4402-scope-bypass.md`
...
- Connected entity: `.project-toolkit/retrospective/2026-08-07-pr-4402-scope-bypass.md`
...
- [ ] REQ-023-AC4: WHEN `_partition_generated` classifies changed paths,
      THE SYSTEM SHALL additionally exclude `.project-toolkit/sessions/**`,
      `.project-toolkit/qa/**`, and `.project-toolkit/memory/episodes/**` as process record
