...
- **US-2**: An architect reads the merged ADR at `.project-toolkit/architecture/ADR-NNN-agent-eval-discipline.md` and decides among {graduate-to-CI, keep-as-audit, scrap}.
...
- Tasks: `.project-toolkit/specs/tasks/TASK-004-agent-eval-harness-spike.md`
