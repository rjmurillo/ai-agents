...
- [ ] .project-toolkit/analysis/aspire-skill-review-matrix.md:"Decision matrix" -- record every source decision
...
- [ ] .project-toolkit/specs/design/DESIGN-019-aspire-skill-review.md:"Testing Strategy" -- record final eval ownership
...
- `.project-toolkit/security/threat-models/TM-aspire-skill-review.md`
- `.project-toolkit/specs/slo/aspire-skill-review.md`
