...
- [ ] **AC-1**: WHEN the audit is run THE SYSTEM SHALL produce a markdown file at `.project-toolkit/audits/YYYY-MM-DD-agent-skill-classification-audit.md` SO THAT the table is durable, version-controlled, and reviewable in a PR.
