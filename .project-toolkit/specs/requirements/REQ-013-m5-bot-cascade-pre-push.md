...
2. `.project-toolkit/retrospective/2026-05-10-pr-1989-recursive-failure.md` (named M5 bot-cascade as the highest-leverage retro intervention, estimated 20 commits saved).
