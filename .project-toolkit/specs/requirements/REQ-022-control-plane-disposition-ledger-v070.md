...
(`.project-toolkit/metrics/control-plane-dispositions-v0.7.0.md`) with one row per
...
- ADR-100 (`.project-toolkit/architecture/ADR-100-retire-pr-size-ceilings.md`):
...
- Connected entity: `.project-toolkit/architecture/ADR-100-retire-pr-size-ceilings.md`
