...
- [`.project-toolkit/planning/`](../planning/) - Implementation plans and task breakdowns
- [`.project-toolkit/architecture/`](../architecture/) - Architecture Decision Records (ADRs)
- [`.agents/archive/`](../../.agents/archive) - Historical documentation
