...
- **EPICs** (`.project-toolkit/roadmap/`) define business outcomes
- **PRDs** (`.project-toolkit/planning/`) define product requirements
- **Specs** (`.project-toolkit/specs/`) define technical requirements with traceability
...
- [AGENT-SYSTEM.md](../../.agents/AGENT-SYSTEM.md)
