...
# Project-specific paths (all contained within .project-toolkit/projects/v0.3.0/)
...
readonly PLAN_FILE="${REPO_ROOT}/.project-toolkit/planning/v0.3.0/PLAN.md"
...
CHAINS[2]="751 734 747 731 1015 1016"
...
ISSUE_BLOCKED_BY[1015]="751"
ISSUE_BLOCKED_BY[1016]="751"
