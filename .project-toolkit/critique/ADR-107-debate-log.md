...
Record under review: `.project-toolkit/architecture/ADR-107-canonical-skill-contracts-and-harness-projections.md`
...
because `.project-toolkit/architecture/README.md` had not been regenerated after adding ADR-107. Fixed by
