...
**ADR**: `.project-toolkit/architecture/ADR-073-adr-lifecycle-frontmatter.md`
...
| 2 | `status: accepted` forgeable (security) | Decision + Negatives: Phase 3 gate binds `accepted` to an adr-review debate-log artifact under `.project-toolkit/critique/` |
