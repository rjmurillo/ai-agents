...
- `.project-toolkit/specs/requirements/REQ-004-agent-eval-harness-spike.md` (AC-6)
- `.project-toolkit/specs/design/DESIGN-004-agent-eval-harness-spike.md`
- `.project-toolkit/architecture/ADR-057-prompt-behavioral-evaluation.md` (sibling)
- `.project-toolkit/architecture/ADR-053-adr-exception-criteria.md` (frontmatter conventions)
