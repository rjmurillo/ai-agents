...
**ADR**: `.project-toolkit/architecture/ADR-006-thin-workflows-testable-modules.md`
...
**Files referenced**:
- `.project-toolkit/architecture/ADR-006-thin-workflows-testable-modules.md` (amendment subject)
- `.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md` (triggering context)
- `.project-toolkit/plans/active/req-003-multi-tool-artifact-build.md` (migration tracking)
- `.project-toolkit/incidents/2026-04-27-pir-plugin-manifest-schema-1773.md` (PR #1773 root-cause framing)
- `.project-toolkit/sessions/2026-04-28-session-1761-req-003-adr-006-amendment-config-data-exception.json` (session evidence)
