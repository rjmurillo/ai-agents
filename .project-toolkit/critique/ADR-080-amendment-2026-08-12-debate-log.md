...
`.project-toolkit/architecture/ADR-080-model-pin-justification-policy.md`. The six
...
| 7 | No probe artifact committed. Rule 4 imposes a stricter evidence standard on a weaker claim. | High | **Accepted.** Method, full result table, and transcripts committed to `.project-toolkit/analysis/2026-08-12-adr-080-copilot-model-resolution.md`. |
| 8 | 110 lines producing roughly 15 lines of decision-relevant content; measurement narrative belongs in `.project-toolkit/analysis/`, precedent already exists. | High | **Accepted.** Amendment cut from 117 lines to a focused correction. |
