...
- **ADR**: `.project-toolkit/architecture/ADR-007-memory-first-architecture.md`
...
- Security vulnerabilities (use `.project-toolkit/security/` instead)
...
- **Debate Log**: `.project-toolkit/critique/ADR-007-debate-log.md`
- **Critic Review**: `.project-toolkit/critique/ADR-007-memory-first-architecture-critique.md`
- **Analyst Review**: `.project-toolkit/critique/ADR-007-analyst-independent-review.md`
- **Related Work Research**: `.project-toolkit/analysis/ADR-007-related-work-research.md`
