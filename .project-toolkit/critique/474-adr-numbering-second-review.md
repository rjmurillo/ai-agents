...
3. **Test cross-references** by attempting to read each ADR mentioned in the index:
   ...
   ls .project-toolkit/architecture/ADR-014*.md
   ls .project-toolkit/architecture/ADR-025*.md
   ls .project-toolkit/architecture/ADR-015*.md
   ls .project-toolkit/architecture/ADR-026*.md
   ```
