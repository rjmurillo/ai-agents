...
2. Confirm episode storage structure matches docs (verified: .project-toolkit/memory/episodes/)
...
|--------------|----------------|-------------|--------|
| Episodes | `.project-toolkit/memory/episodes/` | `.project-toolkit/memory/episodes/` | [PASS] |
| Causal Graph | `.project-toolkit/memory/causality/` | `.project-toolkit/memory/causality/` | [PASS] |
...
```markdown
ADR: ADR-037 (Memory Router Architecture) - See .project-toolkit/architecture/ADR-037-memory-router-architecture.md
```
...
| I2 - Episode storage path | RESOLVED - Standardized on `.project-toolkit/memory/episodes/` | Yes |
...
- [x] Storage paths: `.project-toolkit/memory/episodes/`, `.project-toolkit/memory/causality/`
...
grep -r "\.project-toolkit/memory/episodes" docs/memory-system/ .claude/skills/memory/
```
...
ls -1 .project-toolkit/architecture/ADR-037*.md .project-toolkit/architecture/ADR-038*.md
```
