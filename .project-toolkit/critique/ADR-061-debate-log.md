...
- REQ-003-007 step 5 (`.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md:281-305`) : current inline-body mandate.
- Plan M5-T2 + M7-T3 (`.project-toolkit/plans/active/req-003-multi-tool-artifact-build.md:79,114`) ; M7-T3 explicitly anticipates the "one-body-many-matchers" alternative.
