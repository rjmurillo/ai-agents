...
**Files**:
- `reflexion-memory.md:17-18` - Documents `.project-toolkit/memory/episodes/` (extra space after path in diagram)
- `reflexion-memory.md:60` - Documents `.project-toolkit/memory/episodes/episode-{session-id}.json`
- `api-reference.md:232` - Documents `.project-toolkit/memory/episodes/episode-{SessionId}.json`
...
**Description**: ADR references are consistent but don't include the full file path (`.project-toolkit/architecture/ADR-037-memory-router-architecture.md`). This could become stale if ADRs are reorganized.
