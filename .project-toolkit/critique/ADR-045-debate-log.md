...
14 of 18 agent templates contain hard-coded `.agents/` paths (e.g., `Save to: .project-toolkit/analysis/NNN-[topic]-analysis.md`). Plan claims "zero coupling, cleanest extraction" for agents but path parameterization work is not accounted for.
...
- Critique saved to `.project-toolkit/critique/ADR-045-critique.md` (by critic agent)
- Security review saved to `.project-toolkit/security/ADR-045-framework-extraction-security-review.md`
- Feasibility analysis saved to `.project-toolkit/analysis/adr-045-feasibility-analysis.md`
