...
| Agent | Artifact |
|-------|----------|
| critic | `.project-toolkit/critique/ADR-047-plugin-mode-hook-behavior-critique.md` |
| security | `.project-toolkit/security/SR-002-ADR-047-plugin-mode-security-review.md` |
| analyst | `.project-toolkit/analysis/001-adr-047-plugin-mode-hook-behavior-analysis.md` |
