...
**Retrospectives**:
- `.project-toolkit/retrospective/2026-01-03-adr-generation-quality.md` (11 learnings)
- `.project-toolkit/retrospective/2026-01-03-adr-workflow-bypass.md` (8 learnings)
...
```bash
git ls-files --others --exclude-standard .project-toolkit/architecture/ADR-*.md
```
...
```bash
git status .project-toolkit/critique/
```
