...
`.project-toolkit/critique/ADR-corpus-repair-5189-5201-debate-log.md`. This log carries
...
`.project-toolkit/architecture/README.md`'s Retired table sends a reader from ADR-079 to
