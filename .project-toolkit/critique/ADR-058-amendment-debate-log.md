...
- `.project-toolkit/architecture/ADR-058-agent-eval-discipline.md` (current branch state, post-Amendment-A)
- `.project-toolkit/critique/ADR-058-debate-log.md` (the original ratification log)
...
- `.project-toolkit/specs/requirements/REQ-004-agent-eval-harness-spike.md` (AC-5 normative criteria)
