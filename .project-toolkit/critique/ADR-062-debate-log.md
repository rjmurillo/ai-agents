...
**Artifact**: `.project-toolkit/architecture/ADR-062-conditional-lsp-first-enforcement.md` (Proposed)
...
**Artifact**: the `## Amendment 2026-07-17 (accepted)` section of ADR-062 (issue #3214).
**Protocol**: 6-agent adr-review debate, one joint pass over this amendment and ADR-084 (issue #3215).
**Context**: the #3197 vendored-hook ROI review measured the enforcement layer over 6.5 weeks. The repo owner approved retiring runtime enforcement while keeping the static steering, and accepted the amendment on 2026-07-18. This debate records the consensus that preceded acceptance.
