...
| Artifact | Location |
|----------|----------|
| ADR-042 (main) | `.project-toolkit/architecture/ADR-042-python-migration-strategy.md` |
| Feasibility Analysis | `.project-toolkit/analysis/ADR-042-python-migration-feasibility.md` |
| Design Review | `.project-toolkit/architecture/DESIGN-REVIEW-ADR-042-python-migration.md` |
| Critique | `.project-toolkit/critique/ADR-042-python-migration-critique.md` |
| Independent Review | `.project-toolkit/critique/ADR-042-independent-review.md` |
| Security Review | `.project-toolkit/critique/ADR-042-security-review.md` |
| Strategic Advisory | `.project-toolkit/critique/ADR-042-strategic-advisory.md` |
| Debate Log | `.project-toolkit/critique/ADR-042-debate-log.md` |
