...
are at `.project-toolkit/critique/ADR-corpus-repair-5189-5201-debate-log.md`.
...
1. `.project-toolkit/critique/ADR-042-debate-log.md` records a real six-role debate dated
