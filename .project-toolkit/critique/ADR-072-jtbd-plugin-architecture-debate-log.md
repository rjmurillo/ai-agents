...
Record: `.project-toolkit/architecture/ADR-072-jtbd-plugin-architecture.md`, `status:
...
`.project-toolkit/incidents/2026-04-27-pir-plugin-manifest-schema-1773.md` lines 13 and
...
`.project-toolkit/architecture/README.md` is generated by
...
.project-toolkit/architecture/ADR-064-commands-to-skills-migration.md` exits 1. ADR-064's
...
`.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md:358` to `:359`
...
| P2 | `.project-toolkit/architecture/README.md` was not regenerated after the status flip | Regenerated; both ADR-072 and ADR-101 moved to the Accepted table |
