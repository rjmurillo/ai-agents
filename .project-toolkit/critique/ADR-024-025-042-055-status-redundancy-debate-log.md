...
- `.project-toolkit/architecture/ADR-005-powershell-only-scripting.md` line 16: "Duplicative. Already in frontmatter"
- `.project-toolkit/architecture/ADR-024-github-actions-runner-selection.md` line 16: "Redundant"
