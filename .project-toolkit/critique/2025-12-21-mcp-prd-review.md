...
- Serena fallback to file-based state (`.project-toolkit/sessions/.session-state.json`) provides graceful degradation
...
2. Specify fallback file format: `.project-toolkit/sessions/.session-history.json` (in addition to `.session-state.json`)
