...
Six-role `adr-review` debate on `.project-toolkit/architecture/ADR-097-zero-tool-use-hooks.md`.
...
- Impact table is incomplete against the repo: `.claude/hooks/PostToolUse/README.md`,
  `.project-toolkit/specs/hook-protocol.md:55`, `tests/validation/test_validation_entry_point_imports.py:38`,
