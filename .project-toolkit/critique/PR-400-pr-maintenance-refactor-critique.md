...
- [ ] **Incomplete auto-resolvable file patterns** (Lines 75-104, Resolve-PRConflicts.ps1)
  - Pattern `.agents/*` matches `.agents/HANDOFF.md` but also `.project-toolkit/architecture/ADR-*.md`
...
5. **Exclude ADRs from auto-resolution**
   - Add to line 79: `# Note: .agents/* excludes .project-toolkit/architecture/ADR-*.md (handled separately)`
