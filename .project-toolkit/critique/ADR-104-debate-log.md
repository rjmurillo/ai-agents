...
`.project-toolkit/critique/ADR-084-debate-log.md` and `tests/test_pr_identity_gate.py`
...
every tree, including `.project-toolkit/retrospective/**`, `.project-toolkit/sessions/**`, and
`.project-toolkit/analysis/**`, which the filter's own comment names as the Markdown it
