...
`.project-toolkit/critique/REQ-020-aspire-skill-review-spec-approval-2026-08-11.md`
...
**Recommendation:** Add a concrete verification step (e.g., regex scan of all created `.project-toolkit/analysis/` files for token/URL/email patterns) to TASK-023's acceptance criteria.
