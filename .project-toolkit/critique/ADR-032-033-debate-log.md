...
|----------|------|--------|
| Original ADR | ~~`.project-toolkit/architecture/ADR-032-skill-phase-gates.md`~~ | Deleted (ADR-032 reserved for exit codes per PR #557) |
| Revised ADR | `.project-toolkit/architecture/ADR-033-routing-level-enforcement-gates.md` | Active |
...
| Debate log | `.project-toolkit/critique/ADR-032-033-debate-log.md` | Active |
