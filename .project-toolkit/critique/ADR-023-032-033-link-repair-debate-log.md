...
`/.project-toolkit/critique/...`, which GitHub resolves against the site root rather than
...
`id: ADR-023` (`.project-toolkit/architecture/ADR-023-quality-gate-prompt-testing.md:2`).
