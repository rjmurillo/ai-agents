...
ADR-073 (`.project-toolkit/architecture/ADR-073-adr-lifecycle-frontmatter.md`) is Accepted
...
(`.project-toolkit/architecture/ADR-095-scoped-re-review-axes.md`) is the precedent: it
...
comment, `.project-toolkit/architecture/ADR-073-adr-lifecycle-frontmatter.md:49`,
...
`grep -n Downstream .project-toolkit/architecture/ADR-042-python-migration-strategy.md`);
...
Addendum 56 of `.project-toolkit/qa/2026-08-21-adr-corpus-campaign-qa.md`.

**Restored `date: 2026-08-25`.** `.project-toolkit/architecture/README.md` regenerated
to match. Do not revert this a third time without first running
`git log -p -- .project-toolkit/architecture/ADR-042-python-migration-strategy.md`
