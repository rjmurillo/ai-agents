...
- `.project-toolkit/critique/ADR-036-debate-log.md` (this file)
- `.project-toolkit/security/SR-036-adr-architecture-review.md` (security review)
- `.project-toolkit/critique/036-two-source-agent-template-architecture-critique.md` (critic review)
