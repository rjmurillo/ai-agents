...
accepts spec paths under either `.project-toolkit/specs/` or `.project-toolkit/planning/`.
...
mechanism gap for the sibling `.project-toolkit/plans/` directory. A scope note on that
issue asks whether the fix should cover this directory too.

## Archive

Retired planning documents live in [`.agents/archive/planning/`](../../.agents/archive/planning/README.md).
...
Earlier retired material sits at the root of [`.agents/archive/`](../../.agents/archive),
and retired execution plans sit in [`.agents/archive/plans/`](../../.agents/archive/plans/README.md).
