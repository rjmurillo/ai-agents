...
1. **ADR-025**: GitHub Actions ARM Runner Migration
   - Path: `.project-toolkit/architecture/ADR-025-github-actions-arm-runners.md`
   - Documents runner selection strategy and cost analysis

2. **ADR-015**: Artifact Storage Minimization Strategy
   - Path: `.project-toolkit/architecture/ADR-015-artifact-storage-minimization.md`
   - Documents retention period optimization

3. **ADR-016**: Workflow Execution Optimization Strategy
   - Path: `.project-toolkit/architecture/ADR-016-workflow-execution-optimization.md`
...
5. **Validation Checklist**
   - Path: `.project-toolkit/devops/validation-checklist-cost-optimization.md`
