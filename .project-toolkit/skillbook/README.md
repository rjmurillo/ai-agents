...
2. `.project-toolkit/eval-results/` historical eval outcomes mapped to policies.
3. `.project-toolkit/incidents/` post-mortems (an incident contradicts the policy it
   violated).
4. `.project-toolkit/critique/` explicit critic-agent verdicts.
