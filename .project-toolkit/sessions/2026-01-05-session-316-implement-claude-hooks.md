...
- `.project-toolkit/analysis/claude-code-hooks-opportunity-analysis.md` - Detailed analysis of hook opportunities
...
2. `.project-toolkit/sessions/2026-01-05-session-316-implement-claude-hooks.md` - Session log
