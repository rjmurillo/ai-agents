...
|------|----------|-------|-------------|
| Session log | `.project-toolkit/sessions/YYYY-MM-DD-session-NN.json` | Single session | Always. Canonical session record. |
| **Per-issue handoff** | `.project-toolkit/sessions/handoffs/{YYYY-MM-DD}-{NNNN}-handoff.md` | Single issue, across sessions | When an issue spans multiple sessions |
| Per-branch handoff | `.project-toolkit/handoffs/{branch}/{session}.md` | Single branch | Multi-session branch coordination (ADR-014 Tier 2) |
...
```text
.project-toolkit/sessions/handoffs/{YYYY-MM-DD}-{ISSUE_NUMBER}-handoff.md
```

Examples:

- `.project-toolkit/sessions/handoffs/2026-04-21-1725-handoff.md`
- `.project-toolkit/sessions/handoffs/2026-04-22-1725-handoff.md` (continued next session)
...
Copy from [`../../templates/HANDOFF.md`](../../../.agents/templates/HANDOFF.md). Fill every section. Empty sections are protocol violations, not an optimization.
...
| Question | Source |
|----------|--------|
| What happened in session N? | Session log (`.project-toolkit/sessions/*.json`) |
...
- [`../../templates/HANDOFF.md`](../../../.agents/templates/HANDOFF.md): template
