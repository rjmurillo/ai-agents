...
- `.project-toolkit/architecture/ADR-108-template-owned-skill-files.md` (new, `implemented: true` since #5726) and `.project-toolkit/critique/ADR-108-debate-log.md` (four `adr-review` rounds plus post-consensus edits)
- `.project-toolkit/architecture/ADR-107-canonical-skill-contracts-and-harness-projections.md:61-62` (property 1 exception clause, re-anchored guard lines, Related Decisions bullet)
- `.project-toolkit/specs/requirements/REQ-003-multi-tool-artifact-build.md` (REQ-003-010, REQ-003-005, REQ-003-008, D4 amended in place; three verification commands corrected)
- `.project-toolkit/specs/requirements/REQ-025-skill-guidance-excerpts.md`, `.project-toolkit/specs/design/DESIGN-024-skill-guidance-excerpt-sync.md`, `.project-toolkit/specs/tasks/TASK-030-skill-excerpt-parity-gate.md`, `TASK-025-pilot-excerpts-and-skill-edits.md`, `TASK-027-pilot-skill-tests-and-governance.md`, `.project-toolkit/specs/ontology/skill-guidance-excerpts.md` (renumbered twice after id collisions with #5725 and #5727)
...
- `.project-toolkit/plans/completed/5706-skill-guidance-excerpts.md` (moved from `active/`)
...
- `.project-toolkit/architecture/ADR-108-template-owned-skill-files.md` `status: accepted` (#5736); guard citations in three knowledge-pack files re-anchored (#5737)
