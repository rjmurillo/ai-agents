...
- [x] Generate comment map (`.project-toolkit/pr-comments/PR-143/comments.md`)
...
**Output Directory**: `.project-toolkit/pr-comments/PR-143/`
...
| MUST | Route to qa agent (feature implementation) | [x] | `.project-toolkit/qa/pr-143-issue-feature-review-prompt.md` |
...
- Updated references in 3 files:
  - `.project-toolkit/architecture/ADR-014-feature-request-review-step.md` (title, renumbered from ADR-011)
  - `.project-toolkit/planning/feature-review-workflow-changes.md` (2 references)
