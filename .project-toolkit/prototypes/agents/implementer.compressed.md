...
3. The current per-issue handoff under `.project-toolkit/sessions/handoffs/`, when one exists.
4. `.project-toolkit/architecture/ADR-*.md`: any ADR binding the changed area.
