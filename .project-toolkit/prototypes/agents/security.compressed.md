...
- Phase 1, pre-impl: file `.project-toolkit/security/SR-NNN-<scope>.md` (assets, actors, vectors, controls).
- Phase 2, PIV (MANDATORY): file `.project-toolkit/security/PIV-<feature>.md`. Run security tests on staged code. Block merge until PIV approved.
