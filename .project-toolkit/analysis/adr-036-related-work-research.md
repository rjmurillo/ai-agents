...
|----------|----------|--------------|
| Retrospective: 2-Variant Consolidation Failure | `.project-toolkit/retrospective/2025-12-15-accountability-analysis.md` | **CRITICAL**: Documents 2.4-12.8% similarity between Claude agents and templates, calls it "catastrophic divergence" and a "collective failure" |
| Drift Analysis | `.project-toolkit/analysis/drift-analysis-claude-vs-templates.md` | Details section-by-section drift across 6 high-drift agents |
| Architecture Review | `.project-toolkit/architecture/2-variant-consolidation-review.md` | Architect approved 2-variant approach as "architecturally sound" despite drift data |
| Drift Detection Disaster | `.project-toolkit/retrospective/2025-12-15-drift-detection-disaster.md` | Post-mortem on drift detection failures |
...
**Evidence**: `.project-toolkit/retrospective/2025-12-15-accountability-analysis.md` states:
