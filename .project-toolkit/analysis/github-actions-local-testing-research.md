...
| Session Protocol failure rate | 40% (8/20 runs) | `.project-toolkit/analysis/001-*.md` |
| AI Quality Gate failure rate | 25% (5/20 runs) | `.project-toolkit/analysis/001-*.md` |
| Pester Tests pass rate | 100% (20/20 runs) | `.project-toolkit/analysis/001-*.md` |
...
- `.project-toolkit/analysis/001-workflow-validation-shift-left-analysis.md`
- `.project-toolkit/analysis/002-ai-quality-gate-failure-patterns.md`
