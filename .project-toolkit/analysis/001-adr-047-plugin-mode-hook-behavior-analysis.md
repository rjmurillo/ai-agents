...
| 559 session logs exist | `find .project-toolkit/sessions -name "*.json"` | High |
...
| Plugin marketplace analysis document exists | `.project-toolkit/analysis/claude-code-plugin-marketplaces.md` | High |
...
**Primary Sources**:
- ADR-047: `.project-toolkit/architecture/ADR-047-plugin-mode-hook-behavior.md`
- ADR-045: `.project-toolkit/architecture/ADR-045-framework-extraction-via-plugin-marketplace.md`
- Plugin marketplace analysis: `.project-toolkit/analysis/claude-code-plugin-marketplaces.md`
