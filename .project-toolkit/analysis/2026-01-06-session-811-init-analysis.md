...
**Date**: 2026-01-06
**Context**: Debug excessive tokens/turns during session initialization and design a 10x improvement plan. Source retrospective: [.project-toolkit/retrospective/2026-01-06-session-811-init-retro.md](../retrospective/2026-01-06-session-811-init-retro.md)
...
- **Evidence Automation Gap (validators)**: Required evidence fields (branch, commit SHA, memory names, validation outputs) were not auto-inserted. `scripts/Validate-SessionJson.ps1` flagged missing evidence and format issues.
...
2. **Dry-run protocol validation (pre-commit)**
   - `pwsh scripts/Validate-SessionJson.ps1 -SessionPath ".project-toolkit/sessions/2026-01-06-session-811-init-analysis.md" -Format markdown`
...
5. **Single validation pass**
   - `pwsh scripts/Validate-SessionJson.ps1 -SessionPath ".project-toolkit/sessions/[session-file].md" -Format markdown`
   - `pwsh scripts/Validate-Consistency.ps1`
   - `npx markdownlint-cli2 --fix "**/*.md"`
6. **Commit**
   - `git add .project-toolkit/sessions/*.md`
...
5. **CLI param alignment (validation)**
   ...
   [string]$SessionPath
   ```
   - In `Validate-SessionJson.ps1`, add parameter alias to accept legacy invocations without confusion.
...
- [.project-toolkit/retrospective/2026-01-06-session-811-init-retro.md](../retrospective/2026-01-06-session-811-init-retro.md)