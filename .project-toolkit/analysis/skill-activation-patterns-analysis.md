...
- "review @.project-toolkit/planning/": 10 instances
...
User phrasing: "Review @.project-toolkit/planning/v0.3.0/PLAN.md and pick up the next item"
Match rate: 0%
...
| Phrase | Operation |
|--------|-----------|
| `review @.project-toolkit/planning/*.md` | Review phase with file path |
...
|---------|--------------|-------|
| `.project-toolkit/architecture/ADR-*.md` changed | Always | adr-review |
...
- User message: "Review @.project-toolkit/planning/v0.3.0/PLAN.md and pick up the next item. Create a branch for this work."
