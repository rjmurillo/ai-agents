...
- [ADR-032-skill-phase-gates.md](.project-toolkit/architecture/ADR-032-skill-phase-gates.md)
- [PR #557](https://github.com/rjmurillo/ai-agents/pull/557) - ADR-032 exit code standardization
- [PR #226 Retrospective](.project-toolkit/retrospective/2025-12-22-pr-226-premature-merge-failure.md)
- [Session 67](.project-toolkit/sessions/2025-12-22-session-67-guardrails-synthesis.md)
- [Analysis 065](.project-toolkit/analysis/065-local-guardrails-critical-analysis.md)
- [Critique 001](.project-toolkit/critique/001-everything-deterministic-philosophy-evaluation.md)
