...
Per `.project-toolkit/qa/PR-402/2025-12-26-gap-diagnostics.md` Gap 5:
...
- `.project-toolkit/qa/PR-402/2025-12-26-gap-diagnostics.md` (Gap 5 - CRITICAL_FAIL root cause)
- `.project-toolkit/architecture/ADR-015-security-validation.md` (Security validation requirements)
- `.project-toolkit/architecture/bot-author-feedback-protocol.md` (Lifecycle model specification)
- `.project-toolkit/architecture/Skill-PowerShell-002.md` (Never return null convention)
