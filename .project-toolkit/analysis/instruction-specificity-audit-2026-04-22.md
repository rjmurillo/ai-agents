...
See [`instruction-specificity-prototype-security-compressed.md`](./instruction-specificity-prototype-security-compressed.md) (sibling file in this directory; lives in `.project-toolkit/analysis/` while the audit runs, then moves to `.claude/agents/security.md` in a follow-up PR after behavioral validation).
...
// ... see .project-toolkit/analysis/instruction-specificity-audit-2026-04-22.md, "Methodology" section
```
