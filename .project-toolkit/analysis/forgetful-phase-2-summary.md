...
- `.project-toolkit/analysis/forgetful-import-pattern.md` - Repeatable import pattern
- `.serena/memories/forgetful-migration-plan.md` - Migration strategy
- `.project-toolkit/sessions/2026-01-18-session-01-forgetful-import-phase-1-2.json` - Session log
