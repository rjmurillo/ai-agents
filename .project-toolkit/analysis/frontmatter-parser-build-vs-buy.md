...
Scanning all **2,525** markdown files under `.project-toolkit/architecture`, `.serena/memories`,
...
`.project-toolkit/analysis/frontmatter-probes/probe_divergence_matrix.py`:
