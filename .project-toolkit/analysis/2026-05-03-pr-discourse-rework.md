...
- Reference: `.project-toolkit/architecture/ADR-006-thin-workflows-testable-modules.md`: the count
...
- Change: Before a PR-push Bash command executes, run a fast validator that:
  1. Checks all `.project-toolkit/sessions/*.json` files modified in the branch have `schemaVersion`.
