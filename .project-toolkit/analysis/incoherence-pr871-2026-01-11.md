...
pwsh scripts/Validate-SessionJson.ps1 -SessionPath ".project-toolkit/sessions/[session-log].json"
```
...
#### Source A (Policy)
**File**: `.project-toolkit/architecture/ADR-005-powershell-only-scripting.md`
**Lines**: 21-22, 157
```markdown
...
**File**: `.project-toolkit/architecture/ADR-035-exit-code-standardization.md`
**Lines**: 121, 137-162
```markdown
