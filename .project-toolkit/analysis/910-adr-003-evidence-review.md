...
**Scope**: Five specific claims in ADR-003 at `/home/user/ai-agents/.project-toolkit/architecture/ADR-003-agent-tool-selection-criteria.md`. Source-of-truth agent files at `.github/agents/*.agent.md`. Git history for PR #1517 traceability. GitHub MCP tool enumeration from live session context.
...
- `/home/user/ai-agents/.project-toolkit/architecture/ADR-003-agent-tool-selection-criteria.md`
