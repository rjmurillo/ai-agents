...
1. When referencing files, convert absolute paths to relative:
   - **Wrong**: `D:\src\GitHub\user\repo\.project-toolkit/analysis\file.md`
   - **Right**: `.project-toolkit/analysis/file.md`

2. Use forward slashes for cross-platform compatibility:
   - **Wrong**: `.project-toolkit/analysis\file.md`
   - **Right**: `.project-toolkit/analysis/file.md`
...
- Output location specified as `.project-toolkit/roadmap/product-roadmap.md`
...
- Check existing files before assigning: `ls .project-toolkit/roadmap/EPIC-*.md`
...
Save post-implementation findings to: `.project-toolkit/security/PIV-NNN-[feature].md`
...
|------|---------|---------|----------|
| Epic | `EPIC-NNN-[name].md` | `EPIC-001-auth.md` | `.project-toolkit/roadmap/` |
| Critique | `NNN-[name]-critique.md` | `001-auth-critique.md` | `.project-toolkit/critique/` |
| Threat Model | `TM-NNN-[name].md` | `TM-001-auth.md` | `.project-toolkit/security/` |
| Security Report | `SR-NNN-[name].md` | `SR-001-auth.md` | `.project-toolkit/security/` |
| ADR | `ADR-NNN-[name].md` | `ADR-001-auth.md` | `.project-toolkit/architecture/` |

## Type-Prefixed Artifacts (no number)

| Type | Pattern | Example | Location |
|------|---------|---------|----------|
| PRD | `prd-[name].md` | `prd-auth.md` | `.project-toolkit/planning/` |
| Tasks | `tasks-[name].md` | `tasks-auth.md` | `.project-toolkit/planning/` |
| Plan | `plan-[name].md` | `plan-auth.md` | `.project-toolkit/planning/` |
| Impact Analysis | `impact-analysis-[name]-[domain].md` | `impact-analysis-auth-security.md` | `.project-toolkit/planning/` |
