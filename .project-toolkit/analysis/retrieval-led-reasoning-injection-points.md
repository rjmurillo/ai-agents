...
- Planning: `.project-toolkit/planning/*.md`
...
- Architecture: Read ADRs in .project-toolkit/architecture/
...
- Architecture → ADRs in .project-toolkit/architecture/
...
| Architecture pattern | ADRs in .project-toolkit/architecture/ | ✗ May not reflect project decisions |
