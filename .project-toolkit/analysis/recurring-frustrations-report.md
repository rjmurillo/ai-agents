...
From `.project-toolkit/retrospective/2025-12-18-session-15-retrospective.md`:
...
From `.project-toolkit/retrospective/2025-12-22-pr-226-premature-merge-failure.md`:
...
From `.project-toolkit/sessions/2025-12-22-session-62-handoff-merge-conflict-resolution.md`:
...
- **Tier 1**: Session logs at `.project-toolkit/sessions/YYYY-MM-DD-session-NN.json` (2K tokens, authoritative)
- **Tier 2**: Branch-local at `.project-toolkit/handoffs/{branch}/` (3K tokens, deleted on merge, optional)
...
> - Session logs capture full context in .project-toolkit/sessions/YYYY-MM-DD-session-NN.json
