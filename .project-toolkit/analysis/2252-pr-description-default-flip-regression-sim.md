...
of rjmurillo/ai-agents, populate `.project-toolkit/analysis/2252-regression-data/sample_prs.txt` with the 40 PR
numbers, fetch each PR body to `.project-toolkit/analysis/2252-regression-data/pr_bodies/{n}.md` and file list to
`.project-toolkit/analysis/2252-regression-data/pr_files/{n}.txt` via `gh api`, then run.
