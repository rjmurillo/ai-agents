...
- Artifacts: `.project-toolkit/analysis/aspire-skill-source-inventory.md` and
  `.project-toolkit/analysis/aspire-skill-source-files.json`.
...
- Artifacts: `.project-toolkit/analysis/aspire-skill-review-matrix.md` and
  `.project-toolkit/analysis/aspire-skill-review-matrix.json`, one cited row per source
  skill.
...
- Sanitized reports: `.project-toolkit/analysis/aspire-skill-review-eval-20260812-0207.json`
  and `.md`. Raw per-run output was kept only under gitignored `.project-toolkit/scratch/`.
