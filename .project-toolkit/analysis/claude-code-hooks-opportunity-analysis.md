...
- ADR-008: `.project-toolkit/architecture/ADR-008-protocol-automation-lifecycle-hooks.md`
- ADR-007: `.project-toolkit/architecture/ADR-007-memory-first-architecture.md`
