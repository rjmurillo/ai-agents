...
| Field | Value |
|-------|-------|
| Artifact | `.project-toolkit/architecture/ADR-089-remove-causal-memory-tier.md` |
...
`.project-toolkit/memory/causality/causal-graph.json`, its writer, its custom merge
