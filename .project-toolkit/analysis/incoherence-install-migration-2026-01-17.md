...
**File**: `.project-toolkit/sessions/2026-01-17-session-01-skill-installer.json`
...
@{
    _Common = @{
        ...
        AgentsDirs = @(".project-toolkit/analysis", ".project-toolkit/planning", ...)
    }
...
**File**: `.project-toolkit/planning/claude-compat/vscode-copilot-parity-plan.md`
**Line**: 393
...
Add historical note at top of .project-toolkit/planning/claude-compat/vscode-copilot-parity-plan.md: "HISTORICAL PLAN: Written for v0.1.x (PowerShell installation infrastructure). Prerequisites reference install.ps1 and Config.psd1 which were deleted 2026-01-17 and replaced by skill-installer."

#### Status

✅ RESOLVED, .project-toolkit/planning/claude-compat/vscode-copilot-parity-plan.md: Added historical context header explaining PowerShell infrastructure replacement
...
2. Consider moving to `.project-toolkit/retrospective/` as historical architecture analysis
...
**File**: `.project-toolkit/qa/892-install-script-variable-conflict-test-report.md`
**Lines**: 67, 101
...
**File**: `.project-toolkit/architecture/DESIGN-REVIEW-install-script-parameter-validation.md`
**Lines**: 17, 53, 165
...
**File**: `.project-toolkit/security/SR-vscode-copilot-parity-plan.md`
**Lines**: 76, 125
