...
- `.project-toolkit/architecture/ADR-037-memory-router-architecture.md` (primary)
- `.project-toolkit/analysis/123-phase2a-memory-architecture-review.md` (Phase 2A context)
- `.project-toolkit/architecture/ADR-007-memory-first-architecture.md` (foundational)
