...
**Reference**: `.project-toolkit/analysis/github-keywords-pr-etiquette.md`
...
| Document | Purpose |
|----------|---------|
| `.project-toolkit/analysis/github-keywords-pr-etiquette.md` | Source material (comprehensive guide) |
