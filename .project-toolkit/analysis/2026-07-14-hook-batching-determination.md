...
- A Stop hook created `.project-toolkit/retrospective/2026-07-15-auto-retro.md` and
  changed `.project-toolkit/retrospective/INDEX.md` in the review worktree during a
...
- `.project-toolkit/architecture/ADR-068-consolidated-hook-dispatcher.md`
