...
| Current PRD defines 10 FRs with numeric ID convention | `.project-toolkit/planning/PRD-skills-index-registry.md` | High |
| Collection files contain multiple skills (e.g., `skills-planning.md` has Skill-Planning-001, 002) | File content | High |
| Session 48 routing to 4 agents for feedback | `.project-toolkit/sessions/2025-12-20-session-48-semantic-slug-orchestration.md` | High |
...
- `.project-toolkit/planning/PRD-skills-index-registry.md` - Current PRD (Session 46)
- `.project-toolkit/sessions/2025-12-20-session-48-semantic-slug-orchestration.md` - Proposal context
