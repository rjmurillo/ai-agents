...
Note on earlier inflated counts: a first sweep across `.claude/`, `.agents/`, and `.claude/worktrees/` returned 280+ occurrences. Worktrees are ephemeral; `.project-toolkit/analysis/` is historical. Excluding both, real Flow B surface is ~72 files. Flow A surface is 3 platform yamls plus the build script.
...
- Local: `.project-toolkit/architecture/ADR-002-agent-model-selection-optimization.md`
- Local: `.project-toolkit/architecture/ADR-021-model-routing-strategy.md`
- Local: `.project-toolkit/architecture/ADR-036-two-source-agent-template-architecture.md`
- Local: `.project-toolkit/architecture/ADR-039-agent-model-cost-optimization.md`
