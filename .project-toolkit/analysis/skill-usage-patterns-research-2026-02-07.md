...
pwsh .claude/skills/buy-vs-build/scripts/Invoke-BuildVsBuyAnalysis.ps1 `
    ...
    -OutputPath ".project-toolkit/analysis/build-vs-buy-[decision-slug].md"
```
...
pwsh .claude/skills/code-qualities/scripts/Invoke-QualityAssessment.ps1 `
    ...
    -OutputPath ".project-toolkit/analysis/code-quality-[component].md"
```
...
pwsh .claude/skills/cva/scripts/Invoke-CVAAnalysis.ps1 `
    ...
    -OutputPath ".project-toolkit/analysis/cva-[component].md" `
    -GenerateMatrix `
...
- Results documented in `.project-toolkit/analysis/`
...
**File**: `.project-toolkit/analysis/traceability-build-vs-buy.md`
...
**File**: `.project-toolkit/retrospective/2025-12-15-cva-install-scripts.md`
...
**File**: `.project-toolkit/planning/cva-install-scripts.md`
