...
- **"Zero coupling" for core-agents**: Agent templates contain hard-coded output paths (`.project-toolkit/analysis/`, `.project-toolkit/architecture/`), requiring parameterization.
...
- Example (analyst.shared.md line 383): `Save to: .project-toolkit/analysis/NNN-[topic]-analysis.md`
- Example (architect.shared.md line 224): `Save to: .project-toolkit/architecture/ADR-NNNN-[decision-name].md`
