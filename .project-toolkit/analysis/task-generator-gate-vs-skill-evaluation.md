...
1. **TASK-NNN format ubiquitous**: 227 instances across planning files
   ```bash
   grep -r "TASK-[0-9][0-9][0-9]" .project-toolkit/planning/*.md | wc -l
   # Output: 227
   ```
...
**Source**: `.project-toolkit/critique/tasks-pr-maintenance-authority-critique.md`
...
**Prerequisite**: `.project-toolkit/qa/` report exists
