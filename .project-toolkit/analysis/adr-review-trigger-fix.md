...
**Detection Pattern**:
- Agent output contains: "ADR created/updated: .project-toolkit/architecture/ADR-*.md"
...
**Scope**: Applies to ADR files matching `.project-toolkit/architecture/ADR-*.md` and `docs/architecture/ADR-*.md`
...
- ANY agent creates or updates a file matching `.project-toolkit/architecture/ADR-*.md`
...
- Primary location: `.project-toolkit/architecture/ADR-*.md`
...
**Chosen**: All ADR-*.md files in `.project-toolkit/architecture/` and `docs/architecture/`
