...
- Scope: reference path updates in ADRs (`.project-toolkit/planning/` to `.agents/archive/planning/`, `.project-toolkit/plans/active/` to `.agents/archive/plans/`)

## Context

The archive operation moved 110 finished planning artifacts from `.project-toolkit/planning/` to `.agents/archive/planning/`. Execution plans moved separately from `.project-toolkit/plans/active/` to `.agents/archive/plans/`. Three ADR files contained references to moved plans and required link repoints to maintain navigability.

### Changes Under Review

| ADR | Line | Old path | New path |
|-----|------|----------|----------|
| ADR-006 | 413 | `.project-toolkit/plans/active/req-003-multi-tool-artifact-build.md` | `.agents/archive/plans/req-003-multi-tool-artifact-build.md` |
| ADR-006 | 7 | `../planning/PR-60/002-pr-60-remediation-plan.md` | `../archive/planning/PR-60/002-pr-60-remediation-plan.md` |
| ADR-061 | 110 | `.project-toolkit/plans/active/req-003-multi-tool-artifact-build.md:79` | `.agents/archive/plans/req-003-multi-tool-artifact-build.md:79` |
| ADR-061 | 222 | `.project-toolkit/plans/active/req-003-multi-tool-artifact-build.md:79,114` | `.agents/archive/plans/req-003-multi-tool-artifact-build.md:79,114` |
| ADR-063 | 63 | `.project-toolkit/plans/active/PLAN-skill-catalog-triage-action-slate.md` | `.agents/archive/plans/PLAN-skill-catalog-triage-action-slate.md` |
...
Full debate evidence recorded in: `.project-toolkit/sessions/2026-07-27-session-3431-archive-stale-planning-artifacts.json` (phase: "ADR review debate").
