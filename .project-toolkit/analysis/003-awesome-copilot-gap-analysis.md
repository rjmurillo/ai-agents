...
**Outputs**: Strategic plan document in `.project-toolkit/planning/`
...
**Outputs**: Debug report in `.project-toolkit/analysis/` + fix implementation
...
**Outputs**: TDD cycle documentation in `.project-toolkit/qa/`
