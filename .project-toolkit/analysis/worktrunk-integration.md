...
test = "pwsh scripts/Validate-Session.ps1 -SessionLogPath .project-toolkit/sessions/*.md"
```
...
```toml
[pre-merge]
protocol = "pwsh scripts/Validate-Session.ps1 -SessionLogPath .project-toolkit/sessions/*.md -PreCommit"
