...
| `session-protocol.md` | `.project-toolkit/sessions/**` | `high` |
| `agent-catalog.md` | `templates/agents/**,src/claude/**,.claude/agents/**` | `high` |
| `memory-handoff.md` | `.agents/**,.serena/**` | `normal` |
| `workflow-routing.md` | `templates/**,.project-toolkit/planning/**` | `normal` |
| `phase-execution.md` | `.project-toolkit/planning/**,.project-toolkit/sessions/**` | `normal` |
...
| 3. Workflow Patterns | 282 | PATH-SCOPED-RULE | `workflow-routing.md` (`templates/**,.project-toolkit/planning/**`); canonical workflow source is `src/claude/orchestrator.md`, keep pointer |
...
| Phase Execution Protocol | PATH-SCOPED-RULE | `phase-execution.md` (`.project-toolkit/planning/**,.project-toolkit/sessions/**`) |
...
| Protocol Enforcement Model | PATH-SCOPED-RULE | `session-protocol.md` (`.project-toolkit/sessions/**`); trust vs verification model |
