...
2. **Disk cache (L2)**: JSON files in `.project-toolkit/.cache/traceability/`
...
1. **Duplicate ID Detection** (Priority: P0)
   ...
   **Scenario**:
   ```markdown
   # File: .project-toolkit/specs/requirements/REQ-001-feature-a.md
   ---
   id: REQ-001
   ---

   # File: .project-toolkit/specs/requirements/REQ-001-feature-b.md
   ---
   id: REQ-001
   ---
   ```
...
Remove-Item .project-toolkit/.cache/traceability/*.json -Force -ErrorAction SilentlyContinue
...
Get-ChildItem .project-toolkit/.cache/traceability/*.json | ForEach-Object {
    try {
