...
> **Superseded by**: `.project-toolkit/sessions/2026-01-18-session-11-adr-enforcement-critical-path.json`
...
- ✅ Allowlist Enforcement: Lines 191-246
  - Allowlist defined: `.project-toolkit/sessions/`, `.project-toolkit/analysis/`, `.project-toolkit/retrospective/`, `.serena/memories/`, `.project-toolkit/security/`
...
- `.project-toolkit/architecture/ADR-033-routing-level-enforcement-gates.md`
