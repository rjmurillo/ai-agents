...
| SHIFT-LEFT.md documentation exists | .project-toolkit/devops/SHIFT-LEFT.md | High |
...
1. **#325 - Unified Shift-Left Script**
   ...
   - Documentation: `.project-toolkit/devops/SHIFT-LEFT.md` (exists)
...
2. **#326 - Bot Configuration Tuning**
   ...
   - Path filters: Excludes `.project-toolkit/sessions/`, `.project-toolkit/analysis/`, generated files
...
- `.project-toolkit/planning/2025-12-23-velocity-improvement-plan.md`
- `.project-toolkit/analysis/085-velocity-bottleneck-analysis.md`
