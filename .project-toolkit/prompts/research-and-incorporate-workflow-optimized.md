...
**File Location**: `.project-toolkit/analysis/{topic-slug}.md`
...
## References
- Analysis: .project-toolkit/analysis/{topic-slug}.md
...
Research completed: .project-toolkit/analysis/{topic-slug}.md
...
- Analysis Document: .project-toolkit/analysis/{topic-slug}.md
...
- [ ] Analysis document exists at `.project-toolkit/analysis/{topic-slug}.md`
