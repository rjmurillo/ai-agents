...
| worktree nested checkout gitignore filesystem walker local push red CI green move dirty | [git/git-never-place-worktrees-inside-the-checkout](git/git-never-place-worktrees-inside-the-checkout.md) |
| conflict modify/delete deletion-wins tombstone resurrect removed-upstream | [git/git-conflict-deleted-file](git/git-conflict-deleted-file.md) |
