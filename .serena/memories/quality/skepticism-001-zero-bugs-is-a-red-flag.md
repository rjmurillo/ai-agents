...
**Evidence**: 
- Session 15: 5+ violations despite [skill-usage-mandatory](../usage-mandatory.md), `user-preference-no-bash-python`, [pattern-thin-workflows](../patterns/pattern-thin-workflows.md) memories
