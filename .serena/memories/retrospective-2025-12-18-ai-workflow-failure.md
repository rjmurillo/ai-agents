...
1. `skills-validation` - Added Skill-Validation-004, 005, Skill-Skepticism-001, Anti-patterns
2. `skills-ci-infrastructure` - Added Skill-CI-Research-002
3. `skills-planning` - Added caveats to Skill-Planning-003, 004
