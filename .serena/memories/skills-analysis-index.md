...
| RCA verify premise before implementation issue 5-whys fishbone systematic | [analysis/analysis-002-rca-before-implementation](analysis/analysis-002-rca-before-implementation.md) |
| related issue discovery search prerequisites dependencies planning | [analysis/analysis-003-related-issue-discovery](analysis/analysis-003-related-issue-discovery.md) |
| verify codebase state git grep search missing code claim blocking branch | [analysis/analysis-004-verify-codebase-state](analysis/analysis-004-verify-codebase-state.md) |