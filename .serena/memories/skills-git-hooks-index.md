...
| branch validation pre-commit main master prevent feature | git-001-pre-commit-branch-validation |
| branch recovery main commit mistake reset origin HEAD | git-002-branch-recovery-procedure |
