| Keywords | File |
|----------|------|
| markdown fence code block closing language identifier bleed | [utilities/utilities-markdown-fences](utilities/utilities-markdown-fences.md) |
| pre-commit hook autofix stage bypass security injection | [utilities/utilities-precommit-hook](utilities/utilities-precommit-hook.md) |
| security pattern regex credential injection scan detection | [utilities/utilities-security-patterns](utilities/utilities-security-patterns.md) |
