...
**Problem**: Created bash scripts and tests despite [user-preference-no-bash-python](user-preference-no-bash-python.md) memory.
...
- Prior retrospective: [retrospective-2025-12-17-protocol-compliance](retrospective-2025-12-17-protocol-compliance.md) (validated trust-based failure)
