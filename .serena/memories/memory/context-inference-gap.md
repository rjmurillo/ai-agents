...
- [autonomous-execution-guardrails](../autonomous/autonomous-execution-guardrails.md): STRICTER protocols during autonomy
- [agent-workflow-scope-discipline](../agent-workflow/agent-workflow-scope-discipline.md): Document issues, don't expand scope
