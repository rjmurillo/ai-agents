| Keywords | File |
|----------|------|
| recursive extraction meta-learning rounds termination novelty | retrospective-001-recursive-extraction |
| PR learning extraction commit message pattern success failure | retrospective-001-pr-learning-extraction |
| retrospective skill pipeline automation conversion memory | retrospective-002-retrospective-to-skill-pipeline |
