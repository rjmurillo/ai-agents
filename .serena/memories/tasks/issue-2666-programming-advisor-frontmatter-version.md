...
deterministically; the only changed mirror file was programming-advisor. No
plugin.json bump needed: effective skill version stayed 1.0.0 (top-level value
equals the prior nested value, not a bump).
