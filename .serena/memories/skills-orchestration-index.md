| Keywords | File |
|----------|------|
| parallel execution time savings concurrent dispatch wall-clock | orchestration-parallel-execution |
...
| scope discipline minimal fix debug investigation constraints | skill-scope-002-minimal-viable-fix |
| copilot swe prompting constraints templates scope limits | skill-prompt-002-copilot-swe-constraints |
