| Keywords | File |
|----------|------|
| migration search systematic grep codebase pattern | documentation-001-systematic-migration-search |
| reference taxonomy instructive informational operational categorize | documentation-002-reference-type-taxonomy |
| fallback tool call graceful degradation mcp serena | documentation-003-fallback-preservation |
| pattern consistency syntax identical format canonical | documentation-004-pattern-consistency |
