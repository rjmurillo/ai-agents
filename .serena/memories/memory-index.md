...
|cancel GitHub Actions required checks missing contexts bulk panic recovery event synchronize reopened status producer: [ci/ci-required-run-cancellation-destroys-recovery](ci/ci-required-run-cancellation-destroys-recovery.md) (280)
|strict freshness one front serial PR drain runner cost branch update auto-merge stacked dependent: [ci/ci-strict-freshness-requires-one-front](ci/ci-strict-freshness-requires-one-front.md) (311)
|AI review prompts local before push canonical quality gate remote backstop final diff axis verdicts: [ci/ci-run-canonical-ai-prompts-before-push](ci/ci-run-canonical-ai-prompts-before-push.md) (235)
