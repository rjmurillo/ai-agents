...
| git branch merge conflict checkout cleanup workflow resolution worktree parallel isolation | [skills-git-index](skills-git-index.md) (287) |
...
| context engineering token optimization progressive disclosure just-in-time compaction | [memory/context-engineering-principles](memory/context-engineering-principles.md) (594), [memory/memory-token-efficiency](memory/memory-token-efficiency.md) (861) |
| passive context AGENTS.md skills decision-point retrieval-led compression vercel | [memory/passive-context-vs-skills-vercel-research](memory/passive-context-vs-skills-vercel-research.md) (447), [claude/claude-md-anthropic-best-practices](claude/claude-md-anthropic-best-practices.md) (683), [claude/claude-code-skills-official-guidance](claude/claude-code-skills-official-guidance.md) (623) |
...
- [memory/memory-architecture-serena-primary](memory/memory-architecture-serena-primary.md) (484)
- [memory/memory-size-001-decomposition-thresholds](memory/memory-size-001-decomposition-thresholds.md) (959)
- [memory/memory-system-fragmentation-tech-debt](memory/memory-system-fragmentation-tech-debt.md) (939)
- [memory/memory-token-efficiency](memory/memory-token-efficiency.md) (861)
- [memory/passive-context-vs-skills-vercel-research](memory/passive-context-vs-skills-vercel-research.md) (447)
