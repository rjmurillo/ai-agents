...
|copilot hook generation matcher shim stale cleanup NO-REGEN: [copilot-hook-generation-invariants](copilot-hook-generation-invariants.md) (2263)
|copilot cli hook contract event exit code additionalContext env var CLAUDE_PROJECT_DIR COPILOT_CLI docs silent: [copilot-hooks-observations](copilot-hooks-observations.md) (2134)
