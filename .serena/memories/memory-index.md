...
|git diff origin main direction stale branch deletion behind predates restore: [git/git-diff-direction-on-a-stale-branch](git/git-diff-direction-on-a-stale-branch.md) (48)
