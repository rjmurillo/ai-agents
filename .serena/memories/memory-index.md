...
|adversarial review dispatched model subagent fabricated finding verify number grok gemini terra hangs code-review slot convention misread state conventions in dispatch prompt: [pr-review/dispatched-model-reviewer-reliability](pr-review/dispatched-model-reviewer-reliability.md) (2555)
