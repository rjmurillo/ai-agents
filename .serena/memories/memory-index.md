...
|push retrospective gate documentation-only bypass merge main behind update-branch ruleset strict: [git/git-merging-main-forfeits-the-docs-only-push-bypass](git/git-merging-main-forfeits-the-docs-only-push-bypass.md) (1436)
...
|git branch merge conflict checkout cleanup workflow resolution worktree: [skills-git-index](skills-git-index.md) (465)
