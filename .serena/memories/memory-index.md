...
|python-lint-ratchet not a ratchet changed files zero tolerance no baseline pre-existing E402 ruff push blocked python-lint-count-ratchet lefthook 416 423 ruff_ratchet.py: [python/python-lint-ratchet-is-not-a-ratchet](python/python-lint-ratchet-is-not-a-ratchet.md) (970)
...
|memory size gate characters not bytes wc -c emoji UTF-8 validate_memory_sizes max-chars 10000 len content trim passes scripts/memory regenerator path: [memory/memory-size-gate-counts-characters-not-bytes](memory/memory-size-gate-counts-characters-not-bytes.md) (521)
