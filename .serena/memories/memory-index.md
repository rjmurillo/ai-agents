...
|github pr issue cli gh api review comment batch response: [skills-github-cli-index](skills-github-cli-index.md) (552), [skills-pr-review-index](skills-pr-review-index.md) (1054), [pr-review/pr-review-batch-response-pattern](pr-review/pr-review-batch-response-pattern.md) (699), [project/project-labels-milestones](project/project-labels-milestones.md) (325)
...
|build_all skill references mirror propagate build-all-check pre-push 770s copilot-cli/skills idempotent: [generator-skill-references-mirror-only-through-build-all](generator-skill-references-mirror-only-through-build-all.md) (558)
...
|truncated job log empty grep false negative blob.core.windows.net gh api jobs logs run view log-failed wc -c 123 bytes silent: [ci/ci-a-truncated-job-log-greps-exactly-like-a-clean-one](ci/ci-a-truncated-job-log-greps-exactly-like-a-clean-one.md) (536)
|scratch script stdlib shadow queue.py types.py sys.path module-level executes on import ThreadPoolExecutor SimpleQueue naming: [python/python-scratch-scripts-can-shadow-stdlib-modules](python/python-scratch-scripts-can-shadow-stdlib-modules.md) (620)
|duplicate PR filed is:issue search blind to open pull requests mechanism not symptom search terms superseded wasted branch: [process/process-a-duplicate-check-that-omits-open-prs-is-half-a-check](process/process-a-duplicate-check-that-omits-open-prs-is-half-a-check.md) (614)
...
|git branch merge conflict checkout cleanup workflow resolution worktree: [skills-git-index](skills-git-index.md) (366)
