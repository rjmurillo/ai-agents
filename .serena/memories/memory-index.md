...
|tracking branch push retry fleet CPU load pre-pr-validation timeout SIGKILL: [ci/tracking-branch-push-retries-under-fleet-cpu-load](ci/tracking-branch-push-retries-under-fleet-cpu-load.md) (2261)
|stuck subagent SendMessage nudge git checkout stale local branch GH007 private email worktree identity user.email --worktree: [agent-behavior/stuck-subagent-and-worktree-recovery](agent-behavior/stuck-subagent-and-worktree-recovery.md) (1523)
|spec coverage validator verdict flip flop nondeterministic PASS FAIL PARTIAL rerun: [ci/ai-spec-validator-verdicts-flip-flop-across-reruns](ci/ai-spec-validator-verdicts-flip-flop-across-reruns.md) (341)
|gc_worktrees prune registered worktrees rescue branch admin directory unreachable commits: [workspace/gc-worktrees-report-then-apply](workspace/gc-worktrees-report-then-apply.md) (371)
|validate PR check red advisory blocking signal DESCRIPTION_RESULT: [ci/ci-validate-pr-is-many-gates-only-some-read-the-body](ci/ci-validate-pr-is-many-gates-only-some-read-the-body.md) (3200)
