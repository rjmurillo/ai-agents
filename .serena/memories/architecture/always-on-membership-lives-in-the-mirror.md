...
the number. The two destination trees agree today, measured at `4459b886a`:

| Tree | Consumer | Always-on |
|---|---|---|
| `.github/instructions` | Copilot in this repository | 8 rules, 70,375 bytes |
| `src/copilot-cli/instructions` | the shipped plugin, installed elsewhere | 8 rules, 70,375 bytes |
...
rules measure 70,510 bytes at `.claude/rules/`, 135 more, because the generator
