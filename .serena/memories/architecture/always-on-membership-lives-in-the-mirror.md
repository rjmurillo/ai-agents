...
the number. The two destination trees agree today, measured at `a4129aa44`:

| Tree | Consumer | Always-on |
|---|---|---|
| `.github/instructions` | Copilot in this repository | 8 rules, 72,300 bytes |
...
rules measure 72,435 bytes at `.claude/rules/`, 135 more, because the generator
