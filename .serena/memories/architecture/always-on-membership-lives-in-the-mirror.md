...
|---|---|---|
| `.github/instructions` | Copilot in this repository | 3 rules, 37,153 bytes |
...
rules measure 37,210 bytes at `.claude/rules/`, 57 more, because the generator
...
universalized in it. The plugin ships 22 instruction files against 28 in
...
altogether, which is the whole of the 28-against-22 file gap. So the two trees hold different *rule sets*
