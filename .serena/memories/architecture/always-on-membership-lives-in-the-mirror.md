...
the number. The two destination trees agree today, measured on this branch after issue #5404 added the task-completion contract to `builder-ethos` and the completion-tail audit to `voice`:

| Tree | Consumer | Always-on |
|---|---|---|
| `.github/instructions` | Copilot in this repository | 6 rules, 70,442 bytes |
...
rules measure 70,541 bytes at `.claude/rules/`, 99 more, because the generator
