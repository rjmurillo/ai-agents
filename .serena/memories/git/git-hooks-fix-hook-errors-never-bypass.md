...
# 1. Create session log at .project-toolkit/sessions/YYYY-MM-DD-session-NN.json
...
> The agent MUST create a session log file at `.project-toolkit/sessions/YYYY-MM-DD-session-NN.json`
