...
- Accepted origin/main for .project-toolkit/sessions/2026-01-14-session-02.json and .claude/skills/memory/scripts/Improve-MemoryGraphDensity.ps1 to stay aligned with canonical artifact handling.
