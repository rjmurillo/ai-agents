...
Provide well-supported default technology choices ("paved roads") while allowing deviation with justification ("innovation paths").
...
- Optimized for 80% of common use cases
