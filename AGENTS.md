...
|New capability proposed (Context, or new module/scanner/validator/pipeline)|Run buy-vs-build-framework, Quick tier min, BEFORE spec-generator|Skip: bug fixes, doc-only, refactors w/o new capability surface
